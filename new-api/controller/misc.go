...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"email_auth_enabled":          common.IsEmailAuthEnabled(),
		"sms_auth_enabled":            common.IsSMSAuthEnabled(),
		"sms_default_country_code":    common.SMSDefaultCountryCode,
