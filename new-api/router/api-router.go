...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/wechatpay/notify", controller.WeChatPayNotify)
			userRoute.GET("/wechatpay/notify", controller.WeChatPayNotify)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/wechatpay/refresh", middleware.CriticalRateLimit(), controller.RefreshWeChatPayQRCode)
				selfRoute.POST("/wechatpay/query", middleware.CriticalRateLimit(), controller.QueryWeChatPayByTradeNo)
				selfRoute.POST("/wechatpay/cancel", middleware.CriticalRateLimit(), controller.CancelWeChatPayTopUp)
		...
		apiRouter.POST("/subscription/wechatpay/notify", controller.SubscriptionWeChatPayNotify)
		apiRouter.GET("/subscription/wechatpay/notify", controller.SubscriptionWeChatPayNotify)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.GET("/wechatpay/config", controller.GetWeChatPayConfig)
			optionRoute.PUT("/wechatpay/config", controller.UpdateWeChatPayConfig)
		}
