...
func SetRelayRouter(router *gin.Engine) {
	...
	modelsRouter.Use(middleware.TokenRequestAudit())
	{
	...
	geminiRouter.Use(middleware.TokenRequestAudit())
	{
	...
	geminiCompatibleRouter.Use(middleware.TokenRequestAudit())
	{
	...
	relayV1Router.Use(middleware.TokenRequestAudit())
	...
	relaySunoRouter.Use(middleware.TokenRequestAudit())
	{
	...
	relayGeminiRouter.Use(middleware.TokenRequestAudit())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenRequestAudit())
	{
