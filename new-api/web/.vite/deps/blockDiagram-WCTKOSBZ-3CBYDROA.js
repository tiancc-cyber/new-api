...
import { Graph } from './chunk-ZWCNTER3.js';
import {
  computeLabelTransform,
  getLineFunctionsWithOffset,
} from './chunk-2WVMAWKR.js';
import {
  configureLabelImages,
  getSubGraphTitleMargins,
} from './chunk-GCN5RWLQ.js';
import { createText } from './chunk-KS234T37.js';
import {
  decodeEntities,
  getStylesFromArray,
  utils_default,
...
import { clone_default } from './chunk-ZXFBJHF7.js';
...
var sanitizeText2 = __name(
  (txt) => common_default.sanitizeText(txt, config),
  'sanitizeText',
);
...
var populateBlockDatabase = __name((_blockList, parent) => {
  ...
  const column =
    (columnSettingBlock == null ? void 0 : columnSettingBlock.columns) ?? -1;
...
var _a, _b;
var padding =
  ((_b = (_a = getConfig2()) == null ? void 0 : _a.block) == null
    ? void 0
    : _b.padding) ?? 8;
...
function setBlockSizes(block, db2, siblingWidth = 0, siblingHeight = 0) {
  ...
  if (
    !((_b2 = block == null ? void 0 : block.size) == null ? void 0 : _b2.width)
  ) {
    block.size = {
      width: siblingWidth,
  ...
  if (((_c = block.children) == null ? void 0 : _c.length) > 0) {
    ...
    for (const child of block.children) {
      if (child.size) {
        ...
        child.size.width =
          maxWidth * (child.widthInColumns ?? 1) +
          padding * ((child.widthInColumns ?? 1) - 1);
    ...
    if (
      width <
      (((_e = block == null ? void 0 : block.size) == null
        ? void 0
        : _e.width) || 0)
    ) {
      width =
        ((_f = block == null ? void 0 : block.size) == null
          ? void 0
          : _f.width) || 0;
      const num =
        columns > 0
          ? Math.min(block.children.length, columns)
...
function layoutBlocks(block, db2) {
  ...
  if (
    ...
    const width =
      ((_e =
        (_d = block == null ? void 0 : block.children[0]) == null
          ? void 0
          : _d.size) == null
        ? void 0
        : _e.width) ?? 0;
    const widthOfChildren =
      block.children.length * width + (block.children.length - 1) * padding;
    ...
    let startingPosX = (
      (_g = block == null ? void 0 : block.size) == null ? void 0 : _g.x
    )
      ? ((_h = block == null ? void 0 : block.size) == null ? void 0 : _h.x) +
        (-((_i = block == null ? void 0 : block.size) == null
          ? void 0
          : _i.width) / 2 || 0)
      : -padding;
    let rowPos = 0;
    for (const child of block.children) {
      ...
      if (py != rowPos) {
        rowPos = py;
        startingPosX = (
          (_j = block == null ? void 0 : block.size) == null ? void 0 : _j.x
        )
          ? ((_k = block == null ? void 0 : block.size) == null
              ? void 0
              : _k.x) +
            (-((_l = block == null ? void 0 : block.size) == null
              ? void 0
              : _l.width) / 2 || 0)
          : -padding;
        log.debug(
      ...
      if (columns > 0) {
        columnsFilled = Math.min(
          columnsFilled,
          columns - (columnPos % columns),
        );
      }
...
var addEdgeMarker = __name(
  (svgPath, position, arrowType, url, id, diagramType) => {
    ...
    svgPath.attr(
      `marker-${position}`,
      `url(${url}#${id}_${diagramType}-${endMarkerType}${suffix})`,
    );
  },
  'addEdgeMarker',
);
...
var positionEdgeLabel = __name((edge, paths) => {
  ...
  if (edge.label) {
    ...
    el.attr(
      'transform',
      `translate(${x}, ${y + subGraphTitleTotalMargin / 2})`,
    );
  }
  if (edge.startLabelLeft) {
...
var insertEdge = __name(function (
  ...
  if (
    (head == null ? void 0 : head.intersect) &&
    (tail == null ? void 0 : tail.intersect)
  ) {
  ...
  const svgPath = elem
    ...
    .attr(
      'class',
      ' ' + strokeClasses + (edge.classes ? ' ' + edge.classes : ''),
    )
    .attr('style', edge.style);
  let url = '';
  if (
    getConfig2().flowchart.arrowMarkerAbsolute ||
    getConfig2().state.arrowMarkerAbsolute
  ) {
    url = getUrl(true);
  }
...
var labelHelper = __name(async (parent, node, _classes, isNode) => {
  ...
  if (node.labelText === void 0) {
    ...
    labelText =
      typeof node.labelText === 'string' ? node.labelText : node.labelText[0];
  }
  let text;
...
var rect = __name(async (parent, node) => {
  ...
  const totalHeight = node.positioned
    ? node.height
...
var doublecircle = __name(async (parent, node) => {
  ...
  node.intersect = function (point2) {
    log.info(
      ...
      node,
      bbox.width / 2 + halfPadding + gap,
      point2,
    );
    return intersect_default.circle(
      node,
      bbox.width / 2 + halfPadding + gap,
      point2,
    );
...
var class_box = __name(async (parent, node) => {
  ...
  let verticalPos = 0;
  const hasInterface =
    (_a2 = node.classData.annotations) == null ? void 0 : _a2[0];
...
var insertNode = __name(async (elem, node, renderOptions) => {
  ...
  if (node.haveCallback) {
    nodeElems[node.id].attr(
      'class',
      nodeElems[node.id].attr('class') + ' clickable',
    );
  }
  return newEl;
}, 'insertNode');
...
function getNodeFromBlock(block, db2, positioned = false) {
  ...
  if (
    (((_a2 = vertex == null ? void 0 : vertex.classes) == null
      ? void 0
      : _a2.length) || 0) > 0
  ) {
  ...
  const styles = getStylesFromArray(
    (vertex == null ? void 0 : vertex.styles) ?? [],
  );
  ...
  const node = {
    ...
    padding:
      padding2 ??
      ((_c = (_b2 = getConfig()) == null ? void 0 : _b2.block) == null
        ? void 0
        : _c.padding) ??
      0,
  };
...
var draw = __name(async function (text, id, _version, diagObj) {
  ...
  if (bounds) {
    ...
    const magicFactor = Math.max(
      1,
      Math.round(0.125 * (bounds2.width / bounds2.height)),
    );
...
export { diagram };
//# sourceMappingURL=blockDiagram-WCTKOSBZ-3CBYDROA.js.map
