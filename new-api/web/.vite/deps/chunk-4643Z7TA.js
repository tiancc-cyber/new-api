...
var ESCAPE_REGEX = /[&><"']/g;
var escape = (text2) =>
  String(text2).replace(ESCAPE_REGEX, (match) => ESCAPE_LOOKUP[match]);
...
var retrieveTextFontName = function retrieveTextFontName2(
  fontFamily,
  fontWeight,
  fontShape,
) {
...
var _traverseNonSpaceNodes = function traverseNonSpaceNodes(
  nodes,
  callback,
  prev,
  next,
...
var buildExpression2 = function buildExpression3(
  expression,
  options,
  isOrdgroup,
) {
...
var buildExpressionRow = function buildExpressionRow2(
  expression,
  options,
  isOrdgroup,
) {
...
var Options = class _Options {
  ...
  havingBaseStyle(style) {
    ...
    if (
      this.size === wantSize &&
      this.textSize === _Options.BASESIZE &&
      this.style === style
    ) {
      return this;
    } else {
...
var stretchyEnclose = function stretchyEnclose2(
  inner2,
  label,
  topPad,
  bottomPad,
...
var htmlBuilder$a = (grp, options) => {
  ...
  if (mustShift) {
    ...
    skew =
      (_getBaseSymbol$skew =
        (_getBaseSymbol = getBaseSymbol(body)) == null
          ? void 0
          : _getBaseSymbol.skew) != null
        ? _getBaseSymbol$skew
        : 0;
  }
...
var makeSmallDelim = function makeSmallDelim2(
  delim,
  style,
  center,
  options,
...
var makeLargeDelim = function makeLargeDelim2(
  delim,
  size,
  center,
  options,
...
var makeSizedDelim = function makeSizedDelim2(
  delim,
  size,
  options,
  mode,
...
var traverseSequence = function traverseSequence2(
  delim,
  height,
  sequence,
  options,
...
var htmlBuilder$6 = function htmlBuilder(group, options) {
  ...
  for (
    ...
    while (
      ((_colDescr = colDescr) == null ? void 0 : _colDescr.type) === 'separator'
    ) {
      var _colDescr;
      if (!firstSeparator) {
    ...
    var colSpan = makeSpan(
      [
        'col-align-' +
          (((_colDescr3 = colDescr) == null ? void 0 : _colDescr3.align) ||
            'c'),
      ],
      [colVList],
    );
...
defineFunction({
  ...
  htmlBuilder(group, options) {
    ...
    var minDelimiterHeight =
      inner2.height + inner2.depth + lineClearance + theta;
    var {
      span: img,
      ruleWidth,
      advanceWidth,
    ...
    if (delimDepth > inner2.height + inner2.depth + lineClearance) {
      lineClearance =
        (lineClearance + delimDepth - inner2.height - inner2.depth) / 2;
    }
...
defineFunction({
  ...
  htmlBuilder(group, options) {
    ...
    for (var i = 0; i < text2.length; i++) {
      ...
      body.push(
        makeSymbol(c, 'Typewriter-Regular', group.mode, newOptions, [
          'mord',
          'texttt',
        ]),
      );
...
var Parser = class _Parser {
  ...
  parseGroup(name, breakOnTokenText) {
    ...
    if (text2 === '{' || text2 === '\\begingroup') {
      ...
      if (
        result == null &&
        text2[0] === '\\' &&
        !implicitCommands.hasOwnProperty(text2)
      ) {
        if (this.settings.throwOnError) {
          throw new ParseError(
            'Undefined control sequence: ' + text2,
            firstToken,
          );
        }
  ...
  parseSymbol() {
    ...
    if (
      unicodeSymbols.hasOwnProperty(text2[0]) &&
      !symbols[this.mode][text2[0]]
    ) {
...
//# sourceMappingURL=chunk-4643Z7TA.js.map
