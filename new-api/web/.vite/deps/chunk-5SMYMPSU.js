  ...
  'node_modules/vscode-languageserver-types/lib/esm/main.js'() {
      ...
      function is(value) {
        ...
        return (
          ...
          (Is.undefined(candidate.codeDescription) ||
            Is.string(
              (_a6 = candidate.codeDescription) === null || _a6 === void 0
                ? void 0
                : _a6.href,
            )) &&
    ...
    (function (Is2) {
      ...
      function numberRange(value, min, max) {
        return (
          toString2.call(value) === '[object Number]' &&
          min <= value &&
          value <= max
        );
      }
  ...
  'node_modules/vscode-jsonrpc/lib/common/cancellation.js'(exports) {
    ...
    (function (CancellationToken12) {
      ...
      function is(value) {
        ...
        return (
          candidate &&
          (candidate === CancellationToken12.None ||
            candidate === CancellationToken12.Cancelled ||
      ...
      CancellationToken11 ||
        (exports.CancellationToken = CancellationToken11 = {}),
    );
...
var require_messages = __commonJS({
  'node_modules/vscode-jsonrpc/lib/common/messages.js'(exports) {
    ...
    var ParameterStructures = class _ParameterStructures {
      ...
      static is(value) {
        return (
          value === _ParameterStructures.auto ||
          value === _ParameterStructures.byName ||
          value === _ParameterStructures.byPosition
        );
      }
      toString() {
        return this.kind;
...
var require_sharedArrayCancellation = __commonJS({
  'node_modules/vscode-jsonrpc/lib/common/sharedArrayCancellation.js'(exports) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
    exports.SharedArrayReceiverStrategy = exports.SharedArraySenderStrategy =
      void 0;
    ...
    var AbstractMessageReader = class {
      ...
      asError(error) {
        if (error instanceof Error) {
          ...
          return new Error(
            `Reader received error. Reason: ${Is2.string(error.message) ? error.message : 'unknown'}`,
          );
        }
      }
    };
    ...
    var AbstractMessageWriter = class {
      ...
      asError(error) {
        if (error instanceof Error) {
          ...
          return new Error(
            `Writer received error. Reason: ${Is2.string(error.message) ? error.message : 'unknown'}`,
          );
        }
      }
    };
  ...
  'node_modules/vscode-jsonrpc/lib/common/connection.js'(exports) {
    ...
    (function (IdCancellationReceiverStrategy2) {
      function is(value) {
        ...
        return (
          candidate &&
          (candidate.kind === void 0 || candidate.kind === 'id') &&
          Is2.func(candidate.createCancellationTokenSource) &&
          (candidate.dispose === void 0 || Is2.func(candidate.dispose))
        );
      }
      ...
      function processMessageQueue() {
        ...
        try {
          const messageStrategy =
            options == null ? void 0 : options.messageStrategy;
        ...
        try {
          if (
            ...
            if (messages_1.Message.isRequest(toCancel)) {
              const strategy =
                options == null ? void 0 : options.connectionStrategy;
              const response =
...
var require_main = __commonJS({
  'node_modules/vscode-jsonrpc/lib/browser/main.js'(exports) {
    ...
    Object.defineProperty(exports, '__esModule', { value: true });
    exports.createMessageConnection =
      exports.BrowserMessageWriter =
      exports.BrowserMessageReader =
        void 0;
...
var require_protocol_implementation = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.implementation.js'(
    ...
    (function (ImplementationRequest2) {
      ...
      ImplementationRequest2.messageDirection =
      ...
      ImplementationRequest ||
        (exports.ImplementationRequest = ImplementationRequest = {}),
    );
  },
});
...
var require_protocol_typeDefinition = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.typeDefinition.js'(
    ...
    (function (TypeDefinitionRequest2) {
      ...
      TypeDefinitionRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      ...
      TypeDefinitionRequest ||
        (exports.TypeDefinitionRequest = TypeDefinitionRequest = {}),
    );
  },
});
...
var require_protocol_workspaceFolder = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.workspaceFolder.js'(
    ...
    exports.DidChangeWorkspaceFoldersNotification =
      exports.WorkspaceFoldersRequest = void 0;
    var messages_1 = require_messages2();
    var WorkspaceFoldersRequest;
    (function (WorkspaceFoldersRequest2) {
      WorkspaceFoldersRequest2.method = 'workspace/workspaceFolders';
      WorkspaceFoldersRequest2.messageDirection =
      ...
      WorkspaceFoldersRequest ||
        (exports.WorkspaceFoldersRequest = WorkspaceFoldersRequest = {}),
    );
    ...
    (function (DidChangeWorkspaceFoldersNotification2) {
      ...
      DidChangeWorkspaceFoldersNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DidChangeWorkspaceFoldersNotification2.type =
...
var require_protocol_configuration = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.configuration.js'(
    ...
    (function (ConfigurationRequest2) {
      ...
      ConfigurationRequest2.messageDirection =
        messages_1.MessageDirection.serverToClient;
      ConfigurationRequest2.type = new messages_1.ProtocolRequestType(
        ConfigurationRequest2.method,
      );
    })(
...
var require_protocol_colorProvider = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.colorProvider.js'(
    ...
    (function (DocumentColorRequest2) {
      ...
      DocumentColorRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      ...
      DocumentColorRequest ||
        (exports.DocumentColorRequest = DocumentColorRequest = {}),
    );
    var ColorPresentationRequest;
    (function (ColorPresentationRequest2) {
      ColorPresentationRequest2.method = 'textDocument/colorPresentation';
      ColorPresentationRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      ...
      ColorPresentationRequest ||
        (exports.ColorPresentationRequest = ColorPresentationRequest = {}),
    );
  },
});
...
var require_protocol_foldingRange = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.foldingRange.js'(
    ...
    (function (FoldingRangeRequest2) {
      ...
      FoldingRangeRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      ...
      FoldingRangeRequest ||
        (exports.FoldingRangeRequest = FoldingRangeRequest = {}),
    );
    var FoldingRangeRefreshRequest;
    (function (FoldingRangeRefreshRequest2) {
      FoldingRangeRefreshRequest2.method = `workspace/foldingRange/refresh`;
      FoldingRangeRefreshRequest2.messageDirection =
        messages_1.MessageDirection.serverToClient;
...
var require_protocol_declaration = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.declaration.js'(
    ...
    (function (DeclarationRequest2) {
      ...
      DeclarationRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      ...
      DeclarationRequest ||
        (exports.DeclarationRequest = DeclarationRequest = {}),
    );
  },
});
...
var require_protocol_selectionRange = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.selectionRange.js'(
    ...
    (function (SelectionRangeRequest2) {
      ...
      SelectionRangeRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      ...
      SelectionRangeRequest ||
        (exports.SelectionRangeRequest = SelectionRangeRequest = {}),
    );
  },
});
...
var require_protocol_progress = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.progress.js'(
    ...
    (function (WorkDoneProgressCreateRequest2) {
      ...
      WorkDoneProgressCreateRequest2.messageDirection =
        messages_1.MessageDirection.serverToClient;
    ...
    (function (WorkDoneProgressCancelNotification2) {
      ...
      WorkDoneProgressCancelNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      WorkDoneProgressCancelNotification2.type =
        new messages_1.ProtocolNotificationType(
          WorkDoneProgressCancelNotification2.method,
        );
    })(
...
var require_protocol_callHierarchy = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.callHierarchy.js'(
    ...
    (function (CallHierarchyPrepareRequest2) {
      ...
      CallHierarchyPrepareRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (CallHierarchyIncomingCallsRequest2) {
      ...
      CallHierarchyIncomingCallsRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      CallHierarchyIncomingCallsRequest2.type =
    ...
    (function (CallHierarchyOutgoingCallsRequest2) {
      ...
      CallHierarchyOutgoingCallsRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      CallHierarchyOutgoingCallsRequest2.type =
        new messages_1.ProtocolRequestType(
...
var require_protocol_semanticTokens = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.semanticTokens.js'(
    ...
    (function (SemanticTokensRefreshRequest2) {
      ...
      SemanticTokensRefreshRequest2.messageDirection =
        messages_1.MessageDirection.serverToClient;
...
var require_protocol_showDocument = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.showDocument.js'(
    ...
    (function (ShowDocumentRequest2) {
      ...
      ShowDocumentRequest2.messageDirection =
        messages_1.MessageDirection.serverToClient;
      ...
      ShowDocumentRequest ||
        (exports.ShowDocumentRequest = ShowDocumentRequest = {}),
    );
  },
});
...
var require_protocol_linkedEditingRange = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.linkedEditingRange.js'(
    ...
    (function (LinkedEditingRangeRequest2) {
      ...
      LinkedEditingRangeRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
  ...
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.fileOperations.js'(
    ...
    (function (FileOperationPatternKind2) {
      ...
      FileOperationPatternKind ||
        (exports.FileOperationPatternKind = FileOperationPatternKind = {}),
    );
    var WillCreateFilesRequest;
    (function (WillCreateFilesRequest2) {
      WillCreateFilesRequest2.method = 'workspace/willCreateFiles';
      WillCreateFilesRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      ...
      WillCreateFilesRequest ||
        (exports.WillCreateFilesRequest = WillCreateFilesRequest = {}),
    );
    var DidCreateFilesNotification;
    (function (DidCreateFilesNotification2) {
      DidCreateFilesNotification2.method = 'workspace/didCreateFiles';
      DidCreateFilesNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DidCreateFilesNotification2.type =
        new messages_1.ProtocolNotificationType(
    ...
    (function (WillRenameFilesRequest2) {
      ...
      WillRenameFilesRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      ...
      WillRenameFilesRequest ||
        (exports.WillRenameFilesRequest = WillRenameFilesRequest = {}),
    );
    var DidRenameFilesNotification;
    (function (DidRenameFilesNotification2) {
      DidRenameFilesNotification2.method = 'workspace/didRenameFiles';
      DidRenameFilesNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DidRenameFilesNotification2.type =
        new messages_1.ProtocolNotificationType(
    ...
    (function (DidDeleteFilesNotification2) {
      ...
      DidDeleteFilesNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DidDeleteFilesNotification2.type =
        new messages_1.ProtocolNotificationType(
    ...
    (function (WillDeleteFilesRequest2) {
      ...
      WillDeleteFilesRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      ...
      WillDeleteFilesRequest ||
        (exports.WillDeleteFilesRequest = WillDeleteFilesRequest = {}),
    );
  },
});
...
var require_protocol_moniker = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.moniker.js'(
    ...
    (function (MonikerRequest2) {
      ...
      MonikerRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
...
var require_protocol_typeHierarchy = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.typeHierarchy.js'(
    ...
    (function (TypeHierarchyPrepareRequest2) {
      ...
      TypeHierarchyPrepareRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (TypeHierarchySupertypesRequest2) {
      ...
      TypeHierarchySupertypesRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (TypeHierarchySubtypesRequest2) {
      ...
      TypeHierarchySubtypesRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
...
var require_protocol_inlineValue = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.inlineValue.js'(
    ...
    (function (InlineValueRequest2) {
      ...
      InlineValueRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      InlineValueRequest2.type = new messages_1.ProtocolRequestType(
        InlineValueRequest2.method,
      );
    })(
      InlineValueRequest ||
        (exports.InlineValueRequest = InlineValueRequest = {}),
    );
    var InlineValueRefreshRequest;
    (function (InlineValueRefreshRequest2) {
      InlineValueRefreshRequest2.method = `workspace/inlineValue/refresh`;
      InlineValueRefreshRequest2.messageDirection =
        messages_1.MessageDirection.serverToClient;
...
var require_protocol_inlayHint = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.inlayHint.js'(
    ...
    (function (InlayHintRequest2) {
      ...
      InlayHintRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      InlayHintRequest2.type = new messages_1.ProtocolRequestType(
        InlayHintRequest2.method,
      );
    })(InlayHintRequest || (exports.InlayHintRequest = InlayHintRequest = {}));
    var InlayHintResolveRequest;
    (function (InlayHintResolveRequest2) {
      InlayHintResolveRequest2.method = 'inlayHint/resolve';
      InlayHintResolveRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      ...
      InlayHintResolveRequest ||
        (exports.InlayHintResolveRequest = InlayHintResolveRequest = {}),
    );
    var InlayHintRefreshRequest;
    (function (InlayHintRefreshRequest2) {
      InlayHintRefreshRequest2.method = `workspace/inlayHint/refresh`;
      InlayHintRefreshRequest2.messageDirection =
        messages_1.MessageDirection.serverToClient;
      ...
      InlayHintRefreshRequest ||
        (exports.InlayHintRefreshRequest = InlayHintRefreshRequest = {}),
    );
  },
});
...
var require_protocol_diagnostic = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.diagnostic.js'(
    ...
    (function (DocumentDiagnosticRequest2) {
      ...
      DocumentDiagnosticRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DocumentDiagnosticRequest2.type = new messages_1.ProtocolRequestType(
        DocumentDiagnosticRequest2.method,
      );
      DocumentDiagnosticRequest2.partialResult =
        new vscode_jsonrpc_1.ProgressType();
    })(
    ...
    (function (DiagnosticRefreshRequest2) {
      ...
      DiagnosticRefreshRequest2.messageDirection =
        messages_1.MessageDirection.serverToClient;
      ...
      DiagnosticRefreshRequest ||
        (exports.DiagnosticRefreshRequest = DiagnosticRefreshRequest = {}),
    );
  },
});
  ...
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.notebook.js'(
    ...
    exports.DidCloseNotebookDocumentNotification =
      ...
      exports.NotebookCellKind =
        void 0;
    var vscode_languageserver_types_1 =
      (init_main(), __toCommonJS(main_exports));
    var Is2 = require_is2();
    var messages_1 = require_messages2();
    ...
    (function (ExecutionSummary2) {
      ...
      function is(value) {
        ...
        return (
          ...
          (candidate.success === void 0 || Is2.boolean(candidate.success))
        );
      }
    ...
    (function (NotebookCell2) {
      ...
      function is(value) {
        ...
        return (
          ...
          (candidate.metadata === void 0 ||
            Is2.objectLiteral(candidate.metadata))
        );
      }
      NotebookCell2.is = is;
      function diff(one, two) {
        ...
        if (
          (one.metadata !== void 0 || two.metadata !== void 0) &&
          !equalsMetadata(one.metadata, two.metadata)
        ) {
          result.add('metadata');
        }
        if (
          (one.executionSummary !== void 0 ||
            two.executionSummary !== void 0) &&
    ...
    (function (NotebookDocument2) {
      ...
      function is(value) {
        ...
        return (
          ...
          Is2.typedArray(candidate.cells, NotebookCell.is)
        );
      }
    ...
    (function (NotebookDocumentSyncRegistrationType2) {
      ...
      NotebookDocumentSyncRegistrationType2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      NotebookDocumentSyncRegistrationType2.type =
        new messages_1.RegistrationType(
    ...
    (function (DidOpenNotebookDocumentNotification2) {
      ...
      DidOpenNotebookDocumentNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DidOpenNotebookDocumentNotification2.type =
        new messages_1.ProtocolNotificationType(
    ...
    (function (NotebookCellArrayChange2) {
      ...
      NotebookCellArrayChange ||
        (exports.NotebookCellArrayChange = NotebookCellArrayChange = {}),
    );
    ...
    (function (DidChangeNotebookDocumentNotification2) {
      ...
      DidChangeNotebookDocumentNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DidChangeNotebookDocumentNotification2.type =
        new messages_1.ProtocolNotificationType(
          DidChangeNotebookDocumentNotification2.method,
        );
    ...
    (function (DidSaveNotebookDocumentNotification2) {
      ...
      DidSaveNotebookDocumentNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DidSaveNotebookDocumentNotification2.type =
        new messages_1.ProtocolNotificationType(
    ...
    (function (DidCloseNotebookDocumentNotification2) {
      ...
      DidCloseNotebookDocumentNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DidCloseNotebookDocumentNotification2.type =
        new messages_1.ProtocolNotificationType(
          DidCloseNotebookDocumentNotification2.method,
        );
...
var require_protocol_inlineCompletion = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.inlineCompletion.js'(
    ...
    (function (InlineCompletionRequest2) {
      ...
      InlineCompletionRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      ...
      InlineCompletionRequest ||
        (exports.InlineCompletionRequest = InlineCompletionRequest = {}),
    );
  },
});
...
var require_protocol = __commonJS({
  'node_modules/vscode-languageserver-protocol/lib/common/protocol.js'(
    ...
    (function (TextDocumentFilter2) {
      ...
      TextDocumentFilter ||
        (exports.TextDocumentFilter = TextDocumentFilter = {}),
    );
    ...
    (function (NotebookDocumentFilter2) {
      function is(value) {
        ...
        return (
          Is2.objectLiteral(candidate) &&
          (Is2.string(candidate.notebookType) ||
            Is2.string(candidate.scheme) ||
            Is2.string(candidate.pattern))
        );
      }
    ...
    (function (NotebookCellTextDocumentFilter2) {
      function is(value) {
        ...
        return (
          Is2.objectLiteral(candidate) &&
          (Is2.string(candidate.notebook) ||
            NotebookDocumentFilter.is(candidate.notebook)) &&
          (candidate.language === void 0 || Is2.string(candidate.language))
        );
      }
    ...
    (function (RegistrationRequest2) {
      ...
      RegistrationRequest2.messageDirection =
        messages_1.MessageDirection.serverToClient;
      RegistrationRequest2.type = new messages_1.ProtocolRequestType(
        RegistrationRequest2.method,
      );
    })(
      RegistrationRequest ||
    ...
    (function (UnregistrationRequest2) {
      ...
      UnregistrationRequest2.messageDirection =
        messages_1.MessageDirection.serverToClient;
      UnregistrationRequest2.type = new messages_1.ProtocolRequestType(
        UnregistrationRequest2.method,
      );
    })(
    ...
    (function (InitializeRequest2) {
      ...
      InitializeRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      InitializeRequest2.type = new messages_1.ProtocolRequestType(
        InitializeRequest2.method,
      );
    })(
    ...
    (function (InitializedNotification2) {
      ...
      InitializedNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (ShutdownRequest2) {
      ...
      ShutdownRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      ShutdownRequest2.type = new messages_1.ProtocolRequestType0(
        ShutdownRequest2.method,
      );
    })(ShutdownRequest || (exports.ShutdownRequest = ShutdownRequest = {}));
    var ExitNotification;
    (function (ExitNotification2) {
      ExitNotification2.method = 'exit';
      ExitNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      ExitNotification2.type = new messages_1.ProtocolNotificationType0(
        ExitNotification2.method,
      );
    ...
    (function (DidChangeConfigurationNotification2) {
      ...
      DidChangeConfigurationNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DidChangeConfigurationNotification2.type =
        new messages_1.ProtocolNotificationType(
          DidChangeConfigurationNotification2.method,
        );
    })(
    ...
    (function (ShowMessageNotification2) {
      ...
      ShowMessageNotification2.messageDirection =
        messages_1.MessageDirection.serverToClient;
    ...
    (function (ShowMessageRequest2) {
      ...
      ShowMessageRequest2.messageDirection =
        messages_1.MessageDirection.serverToClient;
      ShowMessageRequest2.type = new messages_1.ProtocolRequestType(
        ShowMessageRequest2.method,
      );
    })(
      ShowMessageRequest ||
        (exports.ShowMessageRequest = ShowMessageRequest = {}),
    );
    var LogMessageNotification;
    (function (LogMessageNotification2) {
      LogMessageNotification2.method = 'window/logMessage';
      LogMessageNotification2.messageDirection =
        messages_1.MessageDirection.serverToClient;
    ...
    (function (TelemetryEventNotification2) {
      ...
      TelemetryEventNotification2.messageDirection =
        messages_1.MessageDirection.serverToClient;
      TelemetryEventNotification2.type =
        new messages_1.ProtocolNotificationType(
    ...
    (function (DidOpenTextDocumentNotification2) {
      ...
      DidOpenTextDocumentNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DidOpenTextDocumentNotification2.type =
        new messages_1.ProtocolNotificationType(
    ...
    (function (DidChangeTextDocumentNotification2) {
      ...
      DidChangeTextDocumentNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DidChangeTextDocumentNotification2.type =
        new messages_1.ProtocolNotificationType(
    ...
    (function (DidCloseTextDocumentNotification2) {
      ...
      DidCloseTextDocumentNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DidCloseTextDocumentNotification2.type =
        new messages_1.ProtocolNotificationType(
    ...
    (function (DidSaveTextDocumentNotification2) {
      ...
      DidSaveTextDocumentNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DidSaveTextDocumentNotification2.type =
        new messages_1.ProtocolNotificationType(
    ...
    (function (WillSaveTextDocumentNotification2) {
      ...
      WillSaveTextDocumentNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      WillSaveTextDocumentNotification2.type =
        new messages_1.ProtocolNotificationType(
    ...
    (function (WillSaveTextDocumentWaitUntilRequest2) {
      ...
      WillSaveTextDocumentWaitUntilRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      WillSaveTextDocumentWaitUntilRequest2.type =
        new messages_1.ProtocolRequestType(
          WillSaveTextDocumentWaitUntilRequest2.method,
        );
    })(
    ...
    (function (DidChangeWatchedFilesNotification2) {
      ...
      DidChangeWatchedFilesNotification2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DidChangeWatchedFilesNotification2.type =
        new messages_1.ProtocolNotificationType(
          DidChangeWatchedFilesNotification2.method,
        );
    })(
    ...
    (function (PublishDiagnosticsNotification2) {
      ...
      PublishDiagnosticsNotification2.messageDirection =
        messages_1.MessageDirection.serverToClient;
      PublishDiagnosticsNotification2.type =
        new messages_1.ProtocolNotificationType(
          PublishDiagnosticsNotification2.method,
        );
    })(
    ...
    (function (CompletionRequest2) {
      ...
      CompletionRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (CompletionResolveRequest2) {
      ...
      CompletionResolveRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (HoverRequest2) {
      ...
      HoverRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (SignatureHelpRequest2) {
      ...
      SignatureHelpRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (DefinitionRequest2) {
      ...
      DefinitionRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (ReferencesRequest2) {
      ...
      ReferencesRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (DocumentHighlightRequest2) {
      ...
      DocumentHighlightRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (DocumentSymbolRequest2) {
      ...
      DocumentSymbolRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (CodeActionRequest2) {
      ...
      CodeActionRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (CodeActionResolveRequest2) {
      ...
      CodeActionResolveRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (WorkspaceSymbolRequest2) {
      ...
      WorkspaceSymbolRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (WorkspaceSymbolResolveRequest2) {
      ...
      WorkspaceSymbolResolveRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (CodeLensRequest2) {
      ...
      CodeLensRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (CodeLensResolveRequest2) {
      ...
      CodeLensResolveRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (CodeLensRefreshRequest2) {
      ...
      CodeLensRefreshRequest2.messageDirection =
        messages_1.MessageDirection.serverToClient;
    ...
    (function (DocumentLinkRequest2) {
      ...
      DocumentLinkRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (DocumentLinkResolveRequest2) {
      ...
      DocumentLinkResolveRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (DocumentFormattingRequest2) {
      ...
      DocumentFormattingRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (DocumentRangeFormattingRequest2) {
      ...
      DocumentRangeFormattingRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (DocumentRangesFormattingRequest2) {
      ...
      DocumentRangesFormattingRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DocumentRangesFormattingRequest2.type =
        new messages_1.ProtocolRequestType(
    ...
    (function (DocumentOnTypeFormattingRequest2) {
      ...
      DocumentOnTypeFormattingRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      DocumentOnTypeFormattingRequest2.type =
        new messages_1.ProtocolRequestType(
    ...
    (function (RenameRequest2) {
      ...
      RenameRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (PrepareRenameRequest2) {
      ...
      PrepareRenameRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
    ...
    (function (ExecuteCommandRequest2) {
      ...
      ExecuteCommandRequest2.messageDirection =
        messages_1.MessageDirection.clientToServer;
      ExecuteCommandRequest2.type = new messages_1.ProtocolRequestType(
        ExecuteCommandRequest2.method,
      );
    })(
    ...
    (function (ApplyWorkspaceEditRequest2) {
      ...
      ApplyWorkspaceEditRequest2.messageDirection =
        messages_1.MessageDirection.serverToClient;
...
var AbstractAstReflection = class {
  ...
  getReferenceType(refInfo) {
    ...
    if (!metaData) {
      throw new Error(
        `Type ${refInfo.container.$type || 'undefined'} not found.`,
      );
    }
    const referenceType =
      (_a6 = metaData.properties[refInfo.property]) == null
        ? void 0
        : _a6.referenceType;
    if (!referenceType) {
      throw new Error(
        `Property ${refInfo.property || 'undefined'} of type ${refInfo.container.$type} is not a reference.`,
      );
    }
  ...
  isSubtype(subtype, supertype) {
    ...
    if (existing !== void 0) {
      ...
      const result = metaData
        ? metaData.superTypes.some((s) => this.isSubtype(s, supertype))
        : false;
...
function isCompositeCstNode(node) {
  return (
    typeof node === 'object' && node !== null && Array.isArray(node.content)
  );
}
...
var StreamImpl = class _StreamImpl {
  ...
  recursiveReduce(iterator, callbackfn, initialValue) {
    ...
    const previousValue = this.recursiveReduce(
      iterator,
      callbackfn,
      initialValue,
    );
  ...
  distinct(by) {
    return new _StreamImpl(
      () => ({ set: /* @__PURE__ */ new Set(), internalState: this.startFn() }),
      (state) => {
        let result;
        do {
...
var EMPTY_STREAM = new StreamImpl(
  () => void 0,
  () => DONE_RESULT,
);
    ...
    return new StreamImpl(
      ...
      (state) => {
        do {
          ...
          state.iterator ||
          state.array ||
          state.collIndex < collections.length
        );
        return DONE_RESULT;
      },
    );
...
var TreeStreamImpl = class extends StreamImpl {
  constructor(root, children, options) {
    super(
      () => ({
        iterators: (options == null ? void 0 : options.includeRoot)
          ? [[root][Symbol.iterator]()]
...
function streamAst(root, options) {
  if (!root) {
    ...
    (options == null ? void 0 : options.range) &&
    !isAstNodeInRange(root, options.range)
  ) {
...
function assignMandatoryProperties(reflection3, node) {
  ...
  for (const property of Object.values(typeMetaData.properties)) {
    if (
      ...
      genericNode[property.name] === void 0
    ) {
...
function getDatatypeNode(cstNode) {
  ...
  let found = false;
  while (current) {
    const definingRule = getContainerOfType(
      current.grammarSource,
      isParserRule,
    );
...
function compareRange(range, to) {
  if (
    range.end.line < to.start.line ||
    (range.end.line === to.start.line &&
      range.end.character <= to.start.character)
  ) {
    return RangeComparison.Before;
  } else if (
    range.start.line > to.end.line ||
    (range.start.line === to.end.line &&
      range.start.character >= to.end.character)
  ) {
    return RangeComparison.After;
  }
  const startInside =
    range.start.line > to.start.line ||
    (range.start.line === to.start.line &&
      range.start.character >= to.start.character);
  const endInside =
    range.end.line < to.end.line ||
    (range.end.line === to.end.line && range.end.character <= to.end.character);
...
function isCommentNode(cstNode, commentNames) {
  return (
    isLeafCstNode(cstNode) && commentNames.includes(cstNode.tokenType.name)
  );
}
...
var ErrorWithLocation = class extends Error {
  constructor(node, message) {
    super(
      node
        ? `${message} at ${node.range.start.line}:${node.range.start.character}`
        : message,
    );
  }
};
...
function getAllRulesUsedForCrossReferences(grammar) {
  ...
  streamAllContents(grammar).forEach((node) => {
    if (isCrossReference(node)) {
      ...
      if (
        isInferredType(node.type.ref) &&
        isParserRule(node.type.ref.$container)
      ) {
...
function findNodeForProperty(node, property, index) {
  ...
  const nodes = findNodesForPropertyInternal(
    node,
    property,
    node.astNode,
    true,
...
function findNodesForPropertyInternal(node, property, element, first2) {
  ...
  if (isCompositeCstNode(node) && node.astNode === element) {
    return node.content.flatMap((e) =>
      findNodesForPropertyInternal(e, property, element, false),
    );
  }
  return [];
}
function findNodesForKeyword(node, keyword) {
  ...
  return findNodesForKeywordInternal(
    node,
    keyword,
    node == null ? void 0 : node.astNode,
  );
}
function findNodeForKeyword(node, keyword, index) {
  ...
  const nodes = findNodesForKeywordInternal(
    node,
    keyword,
    node == null ? void 0 : node.astNode,
  );
  ...
  do {
    ...
    if (!result.done) {
      ...
      if (childNode.astNode === element) {
        if (
          isKeyword(childNode.grammarSource) &&
          childNode.grammarSource.value === keyword
        ) {
...
function findAssignment(cstNode) {
  ...
  while (
    astNode === ((_a6 = cstNode.container) == null ? void 0 : _a6.astNode)
  ) {
...
function findNameAssignmentInternal(type, startNode, cache) {
  ...
  for (const node of streamAllContents(startNode)) {
    if (isAssignment(node) && node.feature.toLowerCase() === 'name') {
      ...
      isSimpleType(node) &&
      ((_a6 = node.typeRef) == null ? void 0 : _a6.ref)
    ) {
...
function isOptionalCardinality(cardinality, element) {
  return (
    cardinality === '?' ||
    cardinality === '*' ||
    (isGroup(element) && Boolean(element.guardCondition))
  );
}
...
function isDataTypeRuleInternal(rule, visited) {
  ...
  for (const node of streamAllContents(rule)) {
    if (isRuleCall(node)) {
      ...
      if (
        isParserRule(node.rule.ref) &&
        !isDataTypeRuleInternal(node.rule.ref, visited)
      ) {
        return false;
      }
...
function getTypeName(type) {
  if (isAbstractParserRule(type)) {
    return isParserRule(type) && isDataTypeRule(type)
      ? type.name
      : (getExplicitRuleType(type) ?? type.name);
...
function getRuleTypeName(rule) {
  ...
  if (isTerminalRule(rule)) {
    ...
    return isParserRule(rule) && isDataTypeRule(rule)
      ? rule.name
      : (getExplicitRuleType(rule) ?? rule.name);
  }
}
...
function abstractElementToRegex(element, flags) {
  ...
  if (isTerminalAlternatives(element)) {
    ...
    throw new Error(
      `Invalid terminal element: ${element == null ? void 0 : element.$type}, ${(_a6 = element == null ? void 0 : element.$cstNode) == null ? void 0 : _a6.text}`,
    );
  }
}
function terminalAlternativesToRegex(alternatives) {
  return withCardinality(
    alternatives.elements.map((e) => abstractElementToRegex(e)).join('|'),
    {
...
function terminalGroupToRegex(group) {
  return withCardinality(
    group.elements.map((e) => abstractElementToRegex(e)).join(''),
    {
...
function untilTokenToRegex(until) {
  return withCardinality(
    `${WILDCARD}*?${abstractElementToRegex(until.terminal)}`,
    {
...
function negateTokenToRegex(negate) {
  return withCardinality(
    `(?!${abstractElementToRegex(negate.terminal)})${WILDCARD}*?`,
    {
...
function characterRangeToRegex(range) {
  if (range.right) {
    return withCardinality(
      `[${keywordToRegex(range.left)}-${keywordToRegex(range.right)}]`,
      {
...
function withCardinality(regex, options) {
  if (options.parenthesized || options.lookahead || options.wrap !== false) {
    const groupConfig =
      options.lookahead ?? (options.parenthesized ? '' : '?:');
...
function createGrammarConfig(services) {
  ...
  for (const rule of grammar.rules) {
    if (
      ...
      isMultilineComment(terminalRegex(rule))
    ) {
...
var NonTerminal = class extends AbstractProduction {
  constructor(options) {
    ...
    assign_default(
      this,
      pickBy_default(options, (v) => v !== void 0),
    );
  }
...
function serializeProduction(node) {
  ...
  if (node instanceof NonTerminal) {
    ...
    if (node.terminalType.PATTERN) {
      serializedTerminal.pattern = isRegExp_default(pattern)
        ? pattern.source
        : pattern;
    }
...
function isOptionalProd(prod, alreadyVisited = []) {
  ...
  if (prod instanceof Alternation) {
    ...
    includes_default(alreadyVisited, prod)
  ) {
    return false;
    ...
    case 'Alternative':
      ...
      for (let i = 0; i < terms.length; i++) {
        ...
        const isOptionalQuantifier =
          atom2.quantifier !== void 0 && atom2.quantifier.atLeast === 0;
        if (
...
function isWholeOptional(ast) {
  ...
  return isArray_default(ast.value)
    ? every_default(ast.value, isWholeOptional)
...
function analyzeTokenTypes(tokenTypes, options) {
  ...
  tracer('misc mapping', () => {
    ...
    patternIdxToLongerAltIdxArr = map_default(onlyRelevantTypes, (clazz) => {
      ...
      if (longerAltType) {
        const longerAltIdxArr = isArray_default(longerAltType)
          ? map_default(longerAltType, (type) =>
              indexOf_default(onlyRelevantTypes, type),
            )
          : [indexOf_default(onlyRelevantTypes, longerAltType)];
        return longerAltIdxArr;
      }
    });
    patternIdxToPushMode = map_default(
      onlyRelevantTypes,
      (clazz) => clazz.PUSH_MODE,
    );
    patternIdxToPopMode = map_default(onlyRelevantTypes, (clazz) =>
      has_default(clazz, 'POP_MODE'),
    );
  });
  ...
  tracer('Line Terminator Handling', () => {
    ...
    patternIdxToCanLineTerminator = map_default(
      onlyRelevantTypes,
      (tokType) => false,
    );
  ...
  if (!options.safeMode) {
    tracer('First Char Optimization', () => {
      charCodeToPatternIdxToConfig = reduce_default(
        onlyRelevantTypes,
...
function validateRegExpPattern(tokenTypes) {
  let errors = [];
  const withRegExpPatterns = filter_default(tokenTypes, (currTokType) =>
    isRegExp_default(currTokType[PATTERN]),
  );
...
function findMissingPatterns(tokenTypes) {
  const tokenTypesWithMissingPattern = filter_default(
    tokenTypes,
    (currType) => {
...
function findInvalidPatterns(tokenTypes) {
  const tokenTypesWithInvalidPattern = filter_default(
    tokenTypes,
    (currType) => {
      const pattern = currType[PATTERN];
      return (
        !isRegExp_default(pattern) &&
        !isFunction_default(pattern) &&
        !has_default(pattern, 'exec') &&
        !isString_default(pattern)
      );
    },
  );
...
function findDuplicatePatterns(tokenTypes) {
    ...
    return reduce_default(
      ...
      (result, innerType) => {
        if (
          ...
          !includes_default(found, innerType) &&
  ...
  const duplicatePatterns = filter_default(
    identicalPatterns,
    (currIdenticalSet) => {
...
function findInvalidGroupType(tokenTypes) {
  const invalidTypes = filter_default(tokenTypes, (clazz) => {
    ...
    return (
      group !== Lexer.SKIPPED && group !== Lexer.NA && !isString_default(group)
    );
  });
...
function findModesThatDoNotExist(tokenTypes, validModes) {
  const invalidModes = filter_default(tokenTypes, (clazz) => {
    return (
      ...
      !includes_default(validModes, clazz.PUSH_MODE)
    );
  });
...
function findUnreachablePatterns(tokenTypes) {
  const errors = [];
  const canBeTested = reduce_default(
    tokenTypes,
    (result, tokType, idx) => {
  ...
  forEach_default(tokenTypes, (aTokType, aIdx) => {
    forEach_default(
      canBeTested,
      ({ str: bStr, idx: bIdx, tokenType: bTokType }) => {
...
function noMetaChar(regExp) {
  ...
  return (
    find_default(metaChars, (char) => regExp.source.indexOf(char) !== -1) ===
    void 0
  );
}
...
function performRuntimeChecks(
  ...
  if (
    has_default(lexerDefinition, MODES) &&
    has_default(lexerDefinition, DEFAULT_MODE) &&
    !has_default(lexerDefinition.modes, lexerDefinition.defaultMode)
  ) {
    errors.push({
...
`,
          ...
          const longerAlt = isArray_default(currTokType.LONGER_ALT)
            ? currTokType.LONGER_ALT
            : [currTokType.LONGER_ALT];
          forEach_default(longerAlt, (currLongerAlt) => {
            if (
              !isUndefined_default(currLongerAlt) &&
              !includes_default(currModeValue, currLongerAlt)
            ) {
              errors.push({
...
function performWarningRuntimeChecks(
  ...
  const allTokenTypes = compact_default(
    flatten_default(values_default(lexerDefinition.modes)),
  );
  const concreteTokenTypes = reject_default(
    allTokenTypes,
...
function expandCategories(tokenTypes) {
  ...
  let searching = true;
  while (searching) {
    categories = compact_default(
      flatten_default(
        map_default(categories, (currTokType) => currTokType.CATEGORIES),
      ),
    );
...
function assignTokenDefaultProps(tokenTypes) {
  forEach_default(tokenTypes, (currTokType) => {
    ...
    if (
      ...
      !isArray_default(currTokType.CATEGORIES)
    ) {
  ...
  constructor(lexerDefinition, config = DEFAULT_LEXER_CONFIG) {
    ...
    this.TRACE_INIT('Lexer Constructor', () => {
      ...
      forEach_default(actualDefinition.modes, (currModeValue, currModeName) => {
        actualDefinition.modes[currModeName] = reject_default(
          currModeValue,
          (currTokType) => isUndefined_default(currTokType),
        );
      });
      ...
      forEach_default(actualDefinition.modes, (currModDef, currModName) => {
        this.TRACE_INIT(`Mode: <${currModName}> processing`, () => {
          ...
          if (isEmpty_default(this.lexerDefinitionErrors)) {
            ...
            this.emptyGroups = assign_default(
              {},
              this.emptyGroups,
      ...
      if (
        ...
        const allErrMessages = map_default(
          this.lexerDefinitionErrors,
          (error) => {
      ...
      this.TRACE_INIT('Failed Optimization Warnings', () => {
        const unOptimizedModes = reduce_default(
          this.canModeBeOptimized,
...
var defaultParserErrorProvider = {
  ...
  buildNoViableAltMessage({
    ...
    if (customUserDescription) {
      ...
      const allLookAheadPaths = reduce_default(
        expectedPathsPerAlt,
        (result, currAltPaths) => result.concat(currAltPaths),
        [],
      );
      const nextValidTokenSequences = map_default(
        allLookAheadPaths,
        (currPath) =>
          `[${map_default(currPath, (currTokenType) => tokenLabel2(currTokenType)).join(', ')}]`,
      );
      const nextValidSequenceItems = map_default(
...
and Non-Terminal names start with a lower case letter.`;
  ...
  buildAlternationPrefixAmbiguityError(options) {
    const pathMsg = map_default(options.prefixPath, (currTok) =>
      tokenLabel2(currTok),
    ).join(', ');
    const occurrence =
...
var NextTerminalAfterAtLeastOneSepWalker = class extends AbstractNextTerminalAfterProductionWalker {
  walkAtLeastOneSep(atleastOneSepProd, currRest, prevRest) {
    if (atleastOneSepProd.idx === this.occurrence) {
      const firstAfterfirstAfterAtLeastOneSep = head_default(
...
function nextPossibleTokensAfter(
  ...
  while (!isEmpty_default(possiblePaths)) {
    ...
    if (currPath === EXIT_ALTERNATIVE) {
      if (
        foundCompletePath &&
        last_default(possiblePaths).idx <= minimalAlternativesIndex
      ) {
        possiblePaths.pop();
      }
      continue;
...
function buildAlternativesLookAheadFunc(
  ...
  if (hasPredicates) {
    ...
    const choiceToAlt = reduce_default(
      singleTokenAlts,
      (result, currAlt, idx) => {
...
function buildSingleAlternativeLookaheadFunction(
  ...
  if (areAllOneTokenLookahead && !dynamicTokensEnabled) {
    ...
    if (
      ...
      isEmpty_default(singleTokensTypes[0].categoryMatches)
    ) {
...
function lookAheadSequenceFromAlternatives(altsDefs, k) {
  const partialAlts = map_default(altsDefs, (currAlt) =>
...
function getLookaheadPathsForOr(occurrence, ruleGrammar, k, orProd) {
  const visitor2 = new InsideDefinitionFinderVisitor(
    occurrence,
...
function isStrictPrefixOfPath(prefix, other) {
  return (
    ...
    every_default(prefix, (tokType, idx) => {
...
function areTokenCategoriesNotUsed(lookAheadPaths) {
  return every_default(lookAheadPaths, (singleAltPaths) =>
    every_default(singleAltPaths, (singlePath) =>
      every_default(singlePath, (token) =>
        isEmpty_default(token.categoryMatches),
      ),
    ),
  );
}
...
function validateLookahead(options) {
  ...
  return map_default(lookaheadValidationErrorMessages, (errorMessage) =>
    Object.assign(
...
function validateGrammar(topLevels, tokenTypes, errMsgProvider, grammarName) {
  const duplicateErrors = flatMap_default(topLevels, (currTopLevel) =>
  ...
  const tooManyAltsErrors = flatMap_default(topLevels, (curRule) =>
    validateTooManyAlts(curRule, errMsgProvider),
  );
  const duplicateRulesError = flatMap_default(topLevels, (curRule) =>
...
function validateDuplicateProductions(topLevelRule, errMsgProvider) {
  ...
  const productionGroups = groupBy_default(
    allRuleProductions,
...
function validateRuleDoesNotAlreadyExist(
  ...
  const errors = [];
  const occurrences = reduce_default(
    allRules,
    (result, curRule) => {
...
function validateNoLeftRecursion(topRule, currRule, errMsgProvider, path = []) {
  ...
  if (isEmpty_default(nextNonTerminals)) {
    ...
    const validNextSteps = difference_default(
      nextNonTerminals,
      path.concat([topRule]),
    );
    const errorsFromNextSteps = flatMap_default(
      validNextSteps,
      (currRefRule) => {
...
function getFirstNoneTerminal(definition) {
  ...
  if (firstProd instanceof NonTerminal) {
    ...
    result = flatten_default(
      map_default(firstProd.definition, (currSubDef) =>
...
function checkAlternativesAmbiguities(
  ...
  const identicalAmbiguities = reduce_default(
    alternatives,
...
function checkPrefixAlternativesAmbiguities(
  ...
  const pathsAndIndices = reduce_default(
    alternatives,
    (result, currAlt, idx) => {
  ...
  const errors = compact_default(
    flatMap_default(pathsAndIndices, (currPathAndIdx) => {
      ...
      const prefixAmbiguitiesPathsAndIndices = filter_default(
        pathsAndIndices,
        (searchPathAndIdx) => {
          return (
            // ignore (skip) ambiguities with this "other" alternative
            alternation2.definition[searchPathAndIdx.idx].ignoreAmbiguities !==
              true &&
      ...
      const currPathPrefixErrors = map_default(
...
var Recoverable = class {
  initRecoverable(config) {
    ...
    this.resyncFollows = {};
    this.recoveryEnabled = has_default(config, 'recoveryEnabled')
  ...
  canRecoverWithSingleTokenInsertion(expectedTokType, follows) {
    ...
    const isMisMatchedTokInFollows =
      find_default(follows, (possibleFollowsTokType) => {
  ...
  getHumanReadableRuleStack() {
    return map_default(this.RULE_STACK, (currShortName) =>
...
var LLkLookaheadStrategy = class {
    ...
    this.maxLookahead =
      (_a6 =
        options === null || options === void 0
          ? void 0
          : options.maxLookahead) !== null && _a6 !== void 0
        ? _a6
  ...
  validateNoLeftRecursion(rules) {
    return flatMap_default(rules, (currTopRule) =>
...
var LooksAhead = class {
  initLooksAhead(config) {
    this.dynamicTokensEnabled = has_default(config, 'dynamicTokensEnabled')
      ? config.dynamicTokensEnabled
      : DEFAULT_PARSER_CONFIG.dynamicTokensEnabled;
    this.maxLookahead = has_default(config, 'maxLookahead')
      ? config.maxLookahead
      : DEFAULT_PARSER_CONFIG.maxLookahead;
    this.lookaheadStrategy = has_default(config, 'lookaheadStrategy')
  ...
  const semanticProto = {
    ...
    validateVisitor: function () {
      ...
      if (!isEmpty_default(semanticDefinitionErrors)) {
        const errorMessages = map_default(
...
var TreeBuilder = class {
  initTreeBuilder(config) {
    ...
    this.nodeLocationTracking = has_default(config, 'nodeLocationTracking')
  ...
  getBaseCstVisitorConstructor() {
    if (isUndefined_default(this.baseCstVisitorConstructor)) {
      const newBaseCstVisitorConstructor = createBaseSemanticVisitorConstructor(
        this.className,
        keys_default(this.gastProductionsCache),
      );
...
var RecognizerEngine = class {
  initRecognizerEngine(tokenVocabulary, config) {
    ...
    if (isArray_default(tokenVocabulary)) {
      ...
      has_default(tokenVocabulary, 'modes') &&
      every_default(
        flatten_default(values_default(tokenVocabulary.modes)),
        isTokenType,
      )
    ) {
      const allTokenTypes2 = flatten_default(
        values_default(tokenVocabulary.modes),
      );
    ...
    const allTokenTypes = has_default(tokenVocabulary, 'modes')
      ? flatten_default(values_default(tokenVocabulary.modes))
      : values_default(tokenVocabulary);
    const noTokenCategoriesUsed = every_default(
      allTokenTypes,
      (tokenConstructor) => isEmpty_default(tokenConstructor.categoryMatches),
    );
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
    ...
    const recoveryValueFunc = has_default(config, 'recoveryValueFunc')
...
var ErrorHandler = class {
  initErrorHandler(config) {
    this._errors = [];
    this.errorMessageProvider = has_default(config, 'errorMessageProvider')
...
function recordProd(
  ...
  assertMethodIdxIsValid(occurrence);
  const prevProd = last_default(this.recordingProdStack);
  const grammarAction = isFunction_default(mainProdArg)
    ? mainProdArg
    : mainProdArg.DEF;
...
function recordOrProd(mainProdArg, occurrence) {
  ...
  const hasPredicates = some_default(alts, (currAlt) =>
    isFunction_default(currAlt.GATE),
  );
...
var Parser = class _Parser {
    ...
    this.TRACE_INIT('performSelfAnalysis', () => {
      ...
      if (isEmpty_default(this.definitionErrors)) {
        if (this.recoveryEnabled) {
          this.TRACE_INIT('computeAllProdsFollows', () => {
            const allFollows = computeAllProdsFollows(
              values_default(this.gastProductionsCache),
            );
        ...
        this.TRACE_INIT('ComputeLookaheadFunctions', () => {
          var _a6, _b;
          (_b = (_a6 = this.lookaheadStrategy).initialize) === null ||
          _b === void 0
            ? void 0
            : _b.call(_a6, {
                rules: values_default(this.gastProductionsCache),
      ...
      if (
        ...
        !isEmpty_default(this.definitionErrors)
      ) {
        defErrorsMsgs = map_default(
 ...
 ${defErrorsMsgs.join('\n-------------------------------\n')}`);
  ...
  constructor(tokenVocabulary, config) {
    ...
    this.skipValidations = has_default(config, 'skipValidations')
...
function block(atn, rule, block2) {
  const handles = filter_default(
    map_default(block2.definition, (e) => atom(atn, rule, e)),
    (e) => e !== void 0,
  );
  if (handles.length === 1) {
    return handles[0];
...
function plus(atn, rule, plus2, handle, sep) {
  ...
  atn.decisionMap[
    buildATNKey(
      rule,
      sep ? 'RepetitionMandatoryWithSeparator' : 'RepetitionMandatory',
      plus2.idx,
    )
  ] = loop;
  epsilon(blkEnd, loop);
...
function star(atn, rule, star2, handle, sep) {
  ...
  atn.decisionMap[
    buildATNKey(rule, sep ? 'RepetitionWithSeparator' : 'Repetition', star2.idx)
  ] = entry;
  return {
    left: entry,
    right: loopEnd,
...
function makeAlts(atn, rule, start, production, ...alts) {
  ...
  atn.decisionMap[buildATNKey(rule, getProdType2(production), production.idx)] =
    start;
  return handle;
}
...
var LLStarLookaheadStrategy = class extends LLkLookaheadStrategy {
  ...
  buildLookaheadForAlternation(options) {
    const { prodOccurrence, rule, hasPredicates, dynamicTokensEnabled } =
      options;
    ...
    if (isLL1Sequence(partialAlts, false) && !dynamicTokensEnabled) {
      ...
      if (hasPredicates) {
        return function (orAlts) {
          ...
          if (orAlts !== void 0 && prediction !== void 0) {
            const gate =
              (_a6 = orAlts[prediction]) === null || _a6 === void 0
                ? void 0
                : _a6.GATE;
      ...
      return function (orAlts) {
        ...
        for (let i = 0; i < length; i++) {
          const gate =
            orAlts === null || orAlts === void 0 ? void 0 : orAlts[i].GATE;
          predicates.set(i, gate === void 0 || gate.call(this));
        }
        const result = adaptivePredict.call(
          this,
          dfas,
          decisionIndex,
          predicates,
...
function buildAdaptivePredictError(path, previous, current) {
  const nextTransitions = flatMap_default(
    previous.configs.elements,
    (e) => e.state.transitions,
  );
  const nextTokenTypes = uniqBy_default(
    nextTransitions
...
var AbstractCstNode = class {
  ...
  get astNode() {
    var _a6, _b;
    const node =
      typeof ((_a6 = this._astNode) == null ? void 0 : _a6.$type) === 'string'
        ? this._astNode
        : (_b = this.container) == null
          ? void 0
          : _b.astNode;
    if (!node) {
      ...
      if (this._rangeCache === void 0) {
        ...
        this._rangeCache = {
          start: firstRange.start,
            ...
            lastRange.end.line < firstRange.start.line
              ? firstRange.start
              : lastRange.end,
        };
      }
...
var ruleSuffix = '​';
var withRuleSuffix = (name) =>
  name.endsWith(ruleSuffix) ? name : name + ruleSuffix;
var AbstractLangiumParser = class {
  constructor(services) {
    ...
    if (
      (_a6 = services.shared.profilers.LangiumProfiler) == null
        ? void 0
        : _a6.isActive('parsing')
    ) {
      this.wrapper = new ProfilerWrapper(
        tokens,
        {
        ...
        services.shared.profilers.LangiumProfiler.createTask(
          'parsing',
...
var LangiumParser = class extends AbstractLangiumParser {
  ...
  rule(rule, impl) {
    ...
    const ruleMethod = this.wrapper.DEFINE_RULE(
      ...
      this.startImplementation(type, infixName, impl).bind(this),
    );
  ...
  parse(input, options = {}) {
    ...
    const ruleMethod = options.rule
      ? this.allRules.get(options.rule)
      : this.mainRule;
    if (!ruleMethod) {
      throw new Error(
        options.rule
          ? `No rule found with name '${options.rule}'`
  ...
  construct() {
    ...
    if ('$infixName' in obj) {
      return this.constructInfix(
        obj,
        this.operatorPrecedence.get(obj.$infixName),
      );
  ...
  getAssignment(feature) {
    if (!this.assignmentMap.has(feature)) {
      ...
      this.assignmentMap.set(feature, {
        assignment,
        crossRef:
          assignment && isCrossReference(assignment.terminal)
            ? assignment.terminal.isMulti
              ? 'multi'
              : 'single'
            : void 0,
      });
...
var LangiumCompletionParser = class extends AbstractLangiumParser {
  ...
  rule(rule, impl) {
    const ruleMethod = this.wrapper.DEFINE_RULE(
      withRuleSuffix(rule.name),
      this.startImplementation(impl).bind(this),
    );
    this.allRules.set(rule.name, ruleMethod);
    if (rule.entry) {
      this.mainRule = ruleMethod;
...
function buildRules(parserContext, grammar) {
  ...
  const parserRules = stream(grammar.rules)
    .filter(isParserRule)
    .filter((rule) => reachable.has(rule));
  ...
  const infixRules = stream(grammar.rules)
    .filter(isInfixRule)
    .filter((rule) => reachable.has(rule));
...
function buildElement(ctx, element, ignoreGuard = false) {
  ...
  return wrap(
    ctx,
    ignoreGuard ? void 0 : getGuardCondition(element),
    method,
    element.cardinality,
  );
}
...
function buildRuleCall(ctx, ruleCall) {
  ...
  if (isAbstractParserRule(rule)) {
    ...
    const predicate =
      ruleCall.arguments.length > 0
        ? buildRuleCallPredicate(rule, ruleCall.arguments)
        : () => ({});
    let subrule;
    return (args) => {
    ...
    throw new ErrorWithLocation(
      ruleCall.$cstNode,
      `Undefined rule: ${ruleCall.rule.$refText}`,
    );
  } else {
...
function buildRuleCallPredicate(rule, namedArgs) {
  ...
  if (hasNamedArguments) {
    const namedPredicates = namedArgs.map((arg) => {
      ...
      return {
        parameterName:
          (_b = (_a6 = arg.parameter) == null ? void 0 : _a6.ref) == null
            ? void 0
            : _b.name,
      ...
      methods.map((method, idx) => {
        ...
        alt.ALT = () => {
          ...
          if (!parser.isRecording()) {
            ...
            if (
              typeof (groupState == null ? void 0 : groupState[idx]) ===
              'undefined'
            ) {
              groupState[idx] = true;
            }
        ...
        if (gate) {
          ...
          alt.GATE = () => {
            const trackedAlternatives = parser.unorderedGroups.get(
              idFunc(orIdx, parser),
            );
            const allow = !(trackedAlternatives == null
              ? void 0
              : trackedAlternatives[idx]);
            return allow;
          };
        }
        return alt;
...
function buildCrossReference(ctx, crossRef, terminal = crossRef.terminal) {
  if (!terminal) {
    if (!crossRef.type.ref) {
      throw new Error(
        'Could not resolve reference to type: ' + crossRef.type.$refText,
      );
    }
...
function getRuleName(ctx, element) {
  if (isAbstractParserRule(element)) {
    ...
    while (!isParserRule(parent)) {
      if (
        isGroup(parent) ||
        isAlternatives(parent) ||
        isUnorderedGroup(parent)
      ) {
...
var DefaultTokenBuilder = class {
  ...
  buildTokens(grammar, options) {
    ...
    const tokens = this.buildKeywordTokens(
      reachableRules,
      terminalTokens,
      options,
    );
  ...
  buildTerminalToken(terminal) {
    ...
    const pattern = this.requiresCustomPattern(regex)
      ? this.regexPatternFunction(regex)
      : regex;
    const tokenType = {
      name: terminal.name,
      PATTERN: pattern,
    ...
    return rules
      ...
      .map((keyword) =>
        this.buildKeywordToken(
          keyword,
          terminalTokens,
          Boolean(options == null ? void 0 : options.caseInsensitive),
        ),
      );
  }
  ...
  findLongerAlt(keyword, terminalTokens) {
    return terminalTokens.reduce((longerAlts, token) => {
      ...
      if (
        (pattern == null ? void 0 : pattern.source) &&
        partialMatches('^' + pattern.source + '$', keyword.value)
      ) {
...
(() => {
  ...
  var t = {
      975: (t2) => {
        ...
        var n2 = {
          resolve: function () {
            for (
              var t3, n3 = '', i2 = false, o2 = arguments.length - 1;
              o2 >= -1 && !i2;
              o2--
            ) {
              var s2;
              o2 >= 0
                ? (s2 = arguments[o2])
                : (void 0 === t3 && (t3 = process.cwd()), (s2 = t3)),
                e2(s2),
                0 !== s2.length &&
                  ((n3 = s2 + '/' + n3), (i2 = 47 === s2.charCodeAt(0)));
            }
            return (
              (n3 = r2(n3, !i2)),
              i2 ? (n3.length > 0 ? '/' + n3 : '/') : n3.length > 0 ? n3 : '.'
            );
          },
          normalize: function (t3) {
            if ((e2(t3), 0 === t3.length)) return '.';
            var n3 = 47 === t3.charCodeAt(0),
              i2 = 47 === t3.charCodeAt(t3.length - 1);
            return (
              0 !== (t3 = r2(t3, !n3)).length || n3 || (t3 = '.'),
              t3.length > 0 && i2 && (t3 += '/'),
              n3 ? '/' + t3 : t3
            );
          },
          ...
          join: function () {
            ...
            for (var t3, r3 = 0; r3 < arguments.length; ++r3) {
              var i2 = arguments[r3];
              e2(i2),
                i2.length > 0 && (void 0 === t3 ? (t3 = i2) : (t3 += '/' + i2));
            }
          ...
          relative: function (t3, r3) {
            ...
            for (
              ...
              h2 < r3.length && 47 === r3.charCodeAt(h2);
              ++h2
            );
            for (
            ...
            for (u2 = i2 + f2 + 1; u2 <= o2; ++u2)
              (u2 !== o2 && 47 !== t3.charCodeAt(u2)) ||
                (0 === g2.length ? (g2 += '..') : (g2 += '/..'));
            return g2.length > 0
              ? g2 + r3.slice(h2 + f2)
              : ((h2 += f2), 47 === r3.charCodeAt(h2) && ++h2, r3.slice(h2));
          },
          ...
          parse: function (t3) {
            ...
            return (
              ...
              -1 === a2 ||
              0 === u2 ||
              (1 === u2 && s2 === a2 - 1 && s2 === h2 + 1)
                ? -1 !== a2 &&
                  (r3.base = r3.name =
                    0 === h2 && o2 ? t3.slice(1, a2) : t3.slice(h2, a2))
                : (0 === h2 && o2
                    ? ((r3.name = t3.slice(1, s2)), (r3.base = t3.slice(1, a2)))
                    : ((r3.name = t3.slice(h2, s2)),
                      (r3.base = t3.slice(h2, a2))),
  ...
  class l {
    constructor(t2, e2, r2, n2, i2, o2 = false) {
      ...
      'object' == typeof t2
        ...
        : ((this.scheme = /* @__PURE__ */ (function (t3, e3) {
            return t3 || e3 ? t3 : 'file';
          })(t2, o2)),
          (this.authority = e2 || c),
          (this.path = (function (t3, e3) {
            switch (t3) {
              case 'https':
              case 'http':
              case 'file':
    ...
    static isUri(t2) {
      return (
        t2 instanceof l ||
        (!!t2 &&
          'string' == typeof t2.authority &&
          'string' == typeof t2.fragment &&
          'string' == typeof t2.path &&
          'string' == typeof t2.query &&
          'string' == typeof t2.scheme &&
          'string' == typeof t2.fsPath &&
          'function' == typeof t2.with &&
          'function' == typeof t2.toString)
      );
    }
    get fsPath() {
      return v(this, false);
    ...
    with(t2) {
      ...
      return (
        void 0 === e2 ? (e2 = this.scheme) : null === e2 && (e2 = c),
        void 0 === r2 ? (r2 = this.authority) : null === r2 && (r2 = c),
        void 0 === n2 ? (n2 = this.path) : null === n2 && (n2 = c),
        void 0 === i2 ? (i2 = this.query) : null === i2 && (i2 = c),
        void 0 === o2 ? (o2 = this.fragment) : null === o2 && (o2 = c),
        e2 === this.scheme &&
        r2 === this.authority &&
        n2 === this.path &&
        i2 === this.query &&
    ...
    static revive(t2) {
      if (t2) {
        if (t2 instanceof l) return t2;
        {
          const e2 = new d(t2);
          return (
            (e2._formatted = t2.external),
            (e2._fsPath = t2._sep === g ? t2.fsPath : null),
            e2
          );
        }
      }
  ...
  class d extends l {
    ...
    toString(t2 = false) {
      return t2
        ? b(this, true)
        : (this._formatted || (this._formatted = b(this, false)),
          this._formatted);
    }
    toJSON() {
      const t2 = { $mid: 1 };
  ...
  function m(t2, e2, r2) {
    ...
    for (let o2 = 0; o2 < t2.length; o2++) {
      ...
      if (
        ...
        -1 !== i2 &&
          ((n2 += encodeURIComponent(t2.substring(i2, o2))), (i2 = -1)),
          void 0 !== n2 && (n2 += t2.charAt(o2));
      else {
    ...
    return (
      -1 !== i2 && (n2 += encodeURIComponent(t2.substring(i2))),
      void 0 !== n2 ? n2 : t2
    );
  }
  function y(t2) {
    ...
    for (let r2 = 0; r2 < t2.length; r2++) {
      ...
      35 === n2 || 63 === n2
        ? (void 0 === e2 && (e2 = t2.substr(0, r2)), (e2 += p[n2]))
        : void 0 !== e2 && (e2 += t2[r2]);
    }
  ...
  function v(t2, e2) {
    ...
    return (
      (r2 =
        t2.authority && t2.path.length > 1 && 'file' === t2.scheme
          ? `//${t2.authority}${t2.path}`
          : 47 === t2.path.charCodeAt(0) &&
              ((t2.path.charCodeAt(1) >= 65 && t2.path.charCodeAt(1) <= 90) ||
                (t2.path.charCodeAt(1) >= 97 &&
                  t2.path.charCodeAt(1) <= 122)) &&
              58 === t2.path.charCodeAt(2)
            ? e2
              ? t2.path.substr(1)
  ...
  function b(t2, e2) {
    ...
    if (s2) {
      if (
        ...
        t3 >= 65 &&
          t3 <= 90 &&
          (s2 = `/${String.fromCharCode(t3 + 32)}:${s2.substr(3)}`);
      } else if (s2.length >= 2 && 58 === s2.charCodeAt(1)) {
        const t3 = s2.charCodeAt(0);
        t3 >= 65 &&
          t3 <= 90 &&
          (s2 = `${String.fromCharCode(t3 + 32)}:${s2.substr(2)}`);
      }
      n2 += r2(s2, true, false);
    }
    return (
  ...
  !(function (t2) {
    (t2.joinPath = function (t3, ...e2) {
      ...
      (t2.resolvePath = function (t3, ...e2) {
        ...
        return (
          n2 && i2[0] === _ && !t3.authority && (i2 = i2.substring(1)),
          t3.with({ path: i2 })
        );
      }),
      (t2.dirname = function (t3) {
        ...
        return (
          1 === e2.length && 46 === e2.charCodeAt(0) && (e2 = ''),
          t3.with({ path: e2 })
        );
      }),
...
(function (UriUtils2) {
  ...
  const isWindows =
    ...
    (process == null ? void 0 : process.platform) === 'win32';
  function equals(a, b) {
    return (
  ...
  function relative(from, to) {
    const fromPath =
      typeof from === 'string' ? URI2.parse(from).path : from.path;
...
var UriTrie = class {
  ...
  has(uri) {
    var _a6;
    return (
      ((_a6 = this.getNode(this.normalizeUri(uri), false)) == null
        ? void 0
        : _a6.element) !== void 0
    );
  }
  ...
  find(uri) {
    var _a6;
    return (_a6 = this.getNode(this.normalizeUri(uri), false)) == null
      ? void 0
      : _a6.element;
  }
  findNode(uri) {
...
(function (DocumentState2) {
  ...
  DocumentState2[(DocumentState2['IndexedReferences'] = 5)] =
    'IndexedReferences';
...
var DefaultLangiumDocumentFactory = class {
  ...
  async fromUri(
    uri,
    cancellationToken = cancellation_exports.CancellationToken.None,
  ) {
  ...
  async createAsync(uri, content, cancelToken) {
    if (typeof content === 'string') {
      ...
      const parseResult = await this.parseAsync(
        uri,
        content.getText(),
        cancelToken,
      );
  ...
  async update(document, cancellationToken) {
    var _a6, _b;
    const oldText =
      (_a6 = document.parseResult.value.$cstNode) == null
        ? void 0
        : _a6.root.fullText;
    const textDocument =
      (_b = this.textDocuments) == null
        ? void 0
        : _b.get(document.uri.toString());
    const text = textDocument
      ? textDocument.getText()
      : await this.fileSystemProvider.readFile(document.uri);
    if (textDocument) {
      Object.defineProperty(document, 'textDocument', {
        value: textDocument,
      });
    } else {
      const textDocumentGetter = this.createTextDocumentGetter(
        document.uri,
        text,
      );
      Object.defineProperty(document, 'textDocument', {
    ...
    if (oldText !== text) {
      document.parseResult = await this.parseAsync(
        document.uri,
        text,
        cancellationToken,
      );
  ...
  createTextDocumentGetter(uri, text) {
    ...
    return () => {
      return (
        textDoc ??
        (textDoc = TextDocument2.create(
          uri.toString(),
          serviceRegistry.getServices(uri).LanguageMetaData.languageId,
          0,
          text ?? '',
        ))
      );
...
var DefaultLangiumDocuments = class {
  ...
  addDocument(document) {
    ...
    if (this.documentTrie.has(uriString)) {
      throw new Error(
        `A document with the URI '${uriString}' is already present.`,
      );
    }
  ...
  async getOrCreateDocument(uri, cancellationToken) {
    ...
    document = await this.langiumDocumentFactory.fromUri(
      uri,
      cancellationToken,
    );
...
var DefaultLinker = class {
  ...
  async link(
    document,
    cancelToken = cancellation_exports.CancellationToken.None,
  ) {
    var _a6;
    ...
    if ('_ref' in ref && ref._ref === void 0) {
      ...
      try {
        ...
        if (isLinkingError(description)) {
          ...
          ref._ref =
            linkedNode ?? this.createLinkingError(refInfo, description);
        }
      } catch (err) {
        console.error(
          `An error occurred while resolving reference to '${ref.$refText}':`,
          err,
        );
  ...
  getCandidates(refInfo) {
    ...
    const descriptions = scope
      .getElements(refInfo.reference.$refText)
      .distinct((desc) => `${desc.documentUri}#${desc.path}`)
      .toArray();
    return descriptions.length > 0
      ? descriptions
      : this.createLinkingError(refInfo);
  }
        ...
        if (isAstNode(this._ref)) {
          ...
          this._ref =
            ...
            linker.createLinkingError(
              { reference, container: node, property },
  ...
  throwCyclicReferenceError(node, property, refText) {
    throw new Error(
      `Cyclic reference resolution detected: ${this.astNodeLocator.getAstNodePath(node)}/${property} (symbol '${refText}')`,
    );
  }
  getLinkedNode(refInfo) {
    try {
      ...
      console.error(
        `An error occurred while resolving reference to '${refInfo.reference.$refText}':`,
        err,
      );
      const errorMessage = err.message ?? String(err);
      return {
  ...
  loadAstNode(nodeDescription) {
    ...
    const doc = this.langiumDocuments().getDocument(
...
var DefaultReferences = class {
  constructor(services) {
    ...
    this.hasMultiReference = streamAst(services.Grammar).some(
      (node) => isCrossReference(node) && node.isMulti,
    );
  }
  findDeclarations(sourceCstNode) {
    if (sourceCstNode) {
      ...
      if (assignment && nodeElem) {
        ...
        if (isReference(reference) || isMultiReference(reference)) {
          ...
          for (const ref of reference) {
            if (
              (isReference(ref) || isMultiReference(ref)) &&
              ref.$refNode &&
      ...
      if (nodeElem) {
        ...
        if (
          nameNode &&
          (nameNode === sourceCstNode || isChildNode(sourceCstNode, nameNode))
        ) {
  ...
  getSelfNodes(node) {
    if (!this.hasMultiReference) {
      ...
      const references = this.index.findAllReferences(
        node,
        this.nodeLocator.getAstNodePath(node),
      );
      const headNode = this.getNodeFromReferenceDescription(references.head());
      if (headNode) {
        for (const ref of streamReferences(headNode)) {
          if (
            isMultiReference(ref.reference) &&
            ref.reference.items.some((item) => item.ref === node)
          ) {
  ...
  findDeclarationNodes(sourceCstNode) {
    ...
    for (const astNode of astNodes) {
      const cstNode =
        this.nameProvider.getNameNode(astNode) ?? astNode.$cstNode;
      if (cstNode) {
...
var MultiMap = class {
   ...
   */
  entries() {
    return stream(this.map.entries()).flatMap(([key, array]) =>
...
var StreamScope = class {
  constructor(elements, outerScope, options) {
    ...
    this.caseInsensitive =
      (options == null ? void 0 : options.caseInsensitive) ?? false;
    this.concatOuterScope =
      (options == null ? void 0 : options.concatOuterScope) ?? true;
  }
  getAllElements() {
    if (this.outerScope) {
...
var DocumentCache = class extends ContextCache {
  ...
  constructor(sharedServices, state) {
    ...
    if (state) {
      this.toDispose.push(
        sharedServices.workspace.DocumentBuilder.onDocumentPhase(
          state,
          (document) => {
      ...
      this.toDispose.push(
        sharedServices.workspace.DocumentBuilder.onUpdate(
          (_changed, deleted) => {
...
var WorkspaceCache = class extends SimpleCache {
  ...
  constructor(sharedServices, state) {
    ...
    if (state) {
      this.toDispose.push(
        sharedServices.workspace.DocumentBuilder.onBuildPhase(state, () => {
          this.clear();
        }),
      );
      this.toDispose.push(
...
var DefaultScopeProvider = class {
  ...
  getGlobalScope(referenceType, _context) {
    return this.globalScopeCache.get(
      referenceType,
      () => new MultiMapScope(this.indexManager.allElements(referenceType)),
    );
  }
};
...
var DefaultJsonSerializer = class {
  ...
  serialize(node, options) {
    ...
    const defaultReplacer = (key, value) =>
      this.replacer(key, value, serializeOptions);
    const replacer = specificReplacer
      ? (key, value) => specificReplacer(key, value, defaultReplacer)
      : defaultReplacer;
    try {
      ...
      return JSON.stringify(
        node,
        replacer,
        options == null ? void 0 : options.space,
      );
    } finally {
  ...
  replacer(
    ...
    if (this.ignoreProperties.has(key)) {
      ...
      if (refValue) {
        ...
        return {
          $error:
            ((_a6 = value.error) == null ? void 0 : _a6.message) ??
      ...
      if (textRegions) {
        ...
        if (
          (!key || value.$document) &&
          (astNode == null ? void 0 : astNode.$textRegion)
        ) {
          astNode.$textRegion.documentURI =
            (_b = this.currentDocument) == null ? void 0 : _b.uri.toString();
        }
      }
      if (sourceText && !key) {
  ...
  getRefNode(root, uri, uriConverter) {
    try {
      ...
      const documentUri = uriConverter
        ? uriConverter(uri.substring(0, fragmentIndex))
      ...
      const node = this.astNodeLocator.getAstNode(
        document.parseResult.value,
        uri.substring(fragmentIndex + 1),
      );
      if (!node) {
...
var DefaultServiceRegistry = class {
  ...
  constructor(services) {
    ...
    this.textDocuments =
      services == null ? void 0 : services.workspace.TextDocuments;
  }
  register(language) {
    ...
    for (const ext of data.fileExtensions) {
      if (this.fileExtensionMap.has(ext)) {
        console.warn(
          `The file extension ${ext} is used by multiple languages. It is now assigned to '${data.languageId}'.`,
        );
      }
    ...
    if (data.fileNames) {
      for (const name of data.fileNames) {
        if (this.fileNameMap.has(name)) {
          console.warn(
            `The file name ${name} is used by multiple languages. It is now assigned to '${data.languageId}'.`,
          );
        }
  ...
  getServices(uri) {
    ...
    const languageId =
      (_b = (_a6 = this.textDocuments) == null ? void 0 : _a6.get(uri)) == null
        ? void 0
        : _b.languageId;
    ...
    const services =
      this.fileNameMap.get(name) ?? this.fileExtensionMap.get(ext);
    if (!services) {
      if (languageId) {
        throw new Error(
...
var ValidationRegistry = class {
  ...
  getChecks(type, categories) {
    let checks = stream(this.entries.get(type)).concat(
  ...
  wrapPreparationException(check, messageContext, thisObj) {
    return async (rootNode, accept, categories, cancelToken) => {
      await this.handleException(
        () => check.call(thisObj, rootNode, accept, categories, cancelToken),
        messageContext,
        accept,
        rootNode,
      );
...
var DefaultDocumentValidator = class {
  ...
  async validateDocument(
    ...
    if (!options.categories || options.categories.includes('built-in')) {
      ...
      if (
        options.stopAfterLexingErrors &&
        diagnostics.some((d) => {
          var _a6;
          return (
            ((_a6 = d.data) == null ? void 0 : _a6.code) ===
      ...
      if (
        options.stopAfterParsingErrors &&
        diagnostics.some((d) => {
          var _a6;
          return (
            ((_a6 = d.data) == null ? void 0 : _a6.code) ===
            DocumentValidator.ParsingError
          );
        })
      ) {
        return diagnostics;
      ...
      if (
        options.stopAfterLinkingErrors &&
        diagnostics.some((d) => {
          var _a6;
          return (
            ((_a6 = d.data) == null ? void 0 : _a6.code) ===
            DocumentValidator.LinkingError
          );
        })
      ) {
        return diagnostics;
    ...
    try {
      diagnostics.push(
        ...(await this.validateAst(parseResult.value, options, cancelToken)),
      );
    } catch (err) {
      if (isOperationCancelled(err)) {
        throw err;
  ...
  processLexingErrors(parseResult, diagnostics, _options) {
    ...
    const lexerDiagnostics = [
      ...
      ...(((_a6 = parseResult.lexerReport) == null
        ? void 0
        : _a6.diagnostics) ?? []),
    ];
  ...
  processLinkingErrors(document, diagnostics, _options) {
    ...
    for (const reference of document.references) {
      ...
      if (linkingError) {
        ...
        diagnostics.push(
          this.toDiagnostic('error', linkingError.message, info),
        );
      }
    }
  }
      ...
      try {
        ...
        for (const node of nodes) {
          ...
          if (nodeOptions.validateNode) {
            try {
              const checks = this.validationRegistry.getChecks(
                node.$type,
                options.categories,
              );
...
var DefaultAstNodeDescriptionProvider = class {
  ...
  createDescription(node, name, document) {
    ...
    const nameSegmentGetter = () =>
      nameNodeSegment ??
      (nameNodeSegment = toDocumentSegment(
        this.nameProvider.getNameNode(node) ?? node.$cstNode,
      ));
    return {
      node,
      name,
...
var DefaultConfigurationProvider = class {
  ...
  initialize(params) {
    ...
    this.workspaceConfig =
      ((_a6 = params.capabilities.workspace) == null
        ? void 0
        : _a6.configuration) ?? false;
  }
      ...
      if (params.register) {
        ...
        params.register({
          ...
          section: languages.map((lang) =>
            this.toSectionName(lang.LanguageMetaData.languageId),
          ),
        });
      }
...
var DefaultDocumentBuilder = class {
    ...
    for (const document of documents) {
      ...
      if (document.state === DocumentState.Validated) {
        if (typeof options.validation === 'boolean' && options.validation) {
          ...
          const categories = this.findMissingValidationCategories(
            document,
            options,
          );
          if (categories.length > 0) {
            this.buildState.set(key, {
              ...
              result:
                (_a6 = this.buildState.get(key)) == null ? void 0 : _a6.result,
            });
  ...
  async update(
    ...
    const changedUris = (
      await Promise.all(changed.map((uri) => this.findChangedUris(uri)))
    ).flat();
    ...
    this.langiumDocuments.all
      .filter(
        (doc) =>
          !allChangedUris.has(doc.uri.toString()) &&
          this.shouldRelink(doc, allChangedUris),
      )
      ...
      this.langiumDocuments.all
        .filter((doc) => {
          ...
          return (
            ...
            !((_a6 = this.buildState.get(doc.uri.toString())) == null
              ? void 0
              : _a6.completed) ||
  ...
  findMissingValidationCategories(document, options) {
    ...
    const allCategories = this.serviceRegistry
      .getServices(document.uri)
      .validation.ValidationRegistry.getAllValidationCategories(document);
    const executedCategories = (
      (_a6 = state == null ? void 0 : state.result) == null
        ? void 0
        : _a6.validationChecks
    )
      ? new Set(
          (_b = state == null ? void 0 : state.result) == null
            ? void 0
            : _b.validationChecks,
        )
      : (state == null ? void 0 : state.completed)
        ? allCategories
        : /* @__PURE__ */ new Set();
    const requestedCategories =
      options === void 0 || options.validation === true
        ? allCategories
        : typeof options.validation === 'object'
          ? (options.validation.categories ?? allCategories)
          : [];
    return stream(requestedCategories)
      .filter((requested) => !executedCategories.has(requested))
      .toArray();
  }
  async findChangedUris(changed) {
    var _a6;
    const document =
      this.langiumDocuments.getDocument(changed) ??
      ((_a6 = this.textDocuments) == null ? void 0 : _a6.get(changed));
    if (document) {
      return [changed];
    }
    try {
  ...
  async emitUpdate(changed, deleted) {
    await Promise.all(
      this.updateListeners.map((listener) => listener(changed, deleted)),
    );
  }
  /**
  ...
  hasTextDocument(doc) {
    var _a6;
    return Boolean(
      (_a6 = this.textDocuments) == null ? void 0 : _a6.get(doc.uri),
    );
  }
  /**
  ...
  resetToState(document, state) {
    switch (state) {
      ...
      case DocumentState.ComputedScopes: {
        const linker = this.serviceRegistry.getServices(document.uri).references
          .Linker;
  ...
  async buildDocuments(documents, options, cancelToken) {
    ...
    await this.runCancelable(
      ...
      cancelToken,
      (doc) => this.langiumDocumentFactory.update(doc, cancelToken),
    );
    await this.runCancelable(
      documents,
      DocumentState.IndexedContent,
      cancelToken,
      (doc) => this.indexManager.updateContent(doc, cancelToken),
    );
    await this.runCancelable(
      documents,
      ...
      cancelToken,
      async (doc) => {
        const scopeComputation = this.serviceRegistry.getServices(doc.uri)
          .references.ScopeComputation;
        doc.localSymbols = await scopeComputation.collectLocalSymbols(
          doc,
          cancelToken,
        );
      },
    ...
    await this.runCancelable(
      ...
      cancelToken,
      (doc) => {
        const linker = this.serviceRegistry.getServices(doc.uri).references
          .Linker;
    ...
    await this.runCancelable(
      ...
      cancelToken,
      (doc) => this.indexManager.updateReferences(doc, cancelToken),
    );
  ...
  async runCancelable(documents, targetState, cancelToken, callback) {
    ...
    const targetStateDocs = documents.filter(
      (doc) => doc.state === targetState,
    );
  ...
  awaitDocumentState(state, uri, cancelToken) {
    ...
    if (!document) {
      return Promise.reject(
        new import_vscode_languageserver_protocol.ResponseError(
          import_vscode_languageserver_protocol.LSPErrorCodes.ServerCancelled,
      ...
      return Promise.reject(
        new import_vscode_languageserver_protocol.ResponseError(
          import_vscode_languageserver_protocol.LSPErrorCodes.RequestFailed,
  ...
  async validate(document, cancelToken) {
    const validator = this.serviceRegistry.getServices(document.uri).validation
      .DocumentValidator;
    const options = this.getBuildOptions(document);
    const validationOptions =
      typeof options.validation === 'object' ? { ...options.validation } : {};
    validationOptions.categories = this.findMissingValidationCategories(
      document,
      options,
    );
    const diagnostics = await validator.validateDocument(
      document,
      validationOptions,
      cancelToken,
    );
    ...
    if (state) {
      ...
      if (state.result.validationChecks) {
        state.result.validationChecks = stream(state.result.validationChecks)
          .concat(validationOptions.categories)
          .distinct()
          .toArray();
      } else {
  ...
  getBuildOptions(document) {
    var _a6;
    return (
      ((_a6 = this.buildState.get(document.uri.toString())) == null
        ? void 0
        : _a6.options) ?? {}
    );
  }
...
var DefaultIndexManager = class {
  ...
  findAllReferences(targetNode, astNodePath) {
    ...
    this.referenceIndex.forEach((docRefs) => {
      docRefs.forEach((refDescr) => {
        if (
          UriUtils.equals(refDescr.targetUri, targetDocUri) &&
          refDescr.targetPath === astNodePath
        ) {
  ...
  getFileDescriptions(uri, nodeType) {
    ...
    const descriptions = this.symbolByTypeIndex.get(uri, nodeType, () => {
      ...
      return allFileDescriptions.filter((e) =>
        this.astReflection.isSubtype(e.type, nodeType),
      );
    });
    return descriptions;
  }
  ...
  async updateContent(
    ...
    const exports =
      await services.references.ScopeComputation.collectExportedSymbols(
        document,
        cancelToken,
      );
  ...
  async updateReferences(
    ...
    const services = this.serviceRegistry.getServices(document.uri);
    const indexData =
      await services.workspace.ReferenceDescriptionProvider.createDescriptions(
        document,
        cancelToken,
      );
  ...
  isAffected(document, changedUris) {
    ...
    return references.some(
      (ref) => !ref.local && changedUris.has(ref.targetUri.toString()),
    );
  }
};
...
var DefaultWorkspaceManager = class {
  ...
  initialized(_params) {
    return this.mutex.write((token) =>
      this.initializeWorkspace(this.folders ?? [], token),
    );
  }
  ...
  async traverseFolder(folderPath, uris) {
    try {
      ...
      console.error(
        'Failure to read directory content of ' + folderPath.toString(true),
        e,
      );
    }
  }
...
var DefaultLexer = class {
  constructor(services) {
    ...
    const lexerTokens = isTokenTypeDictionary(tokens)
  ...
  tokenize(text, _options = DEFAULT_TOKENIZE_OPTIONS) {
    ...
    return {
      ...
      report:
        (_b = (_a6 = this.tokenBuilder).flushLexingReport) == null
          ? void 0
          : _b.call(_a6, text),
    };
  }
...
function isTokenTypeArray(tokenVocabulary) {
  return (
    Array.isArray(tokenVocabulary) &&
    (tokenVocabulary.length === 0 || 'name' in tokenVocabulary[0])
  );
}
function isIMultiModeLexerDefinition(tokenVocabulary) {
  return (
    ...
    'defaultMode' in tokenVocabulary
  );
}
function isTokenTypeDictionary(tokenVocabulary) {
  return (
    !isTokenTypeArray(tokenVocabulary) &&
    !isIMultiModeLexerDefinition(tokenVocabulary)
  );
}
...
function isJSDoc(node, options) {
  ...
  return (
    Boolean(firstRegex == null ? void 0 : firstRegex.exec(first2)) &&
    Boolean(lastRegex == null ? void 0 : lastRegex.exec(last))
  );
}
...
function tokenize(context) {
  ...
  for (let i = 0; i < context.lines.length; i++) {
    ...
    if (first2 && context.options.start) {
      const match =
        (_a6 = context.options.start) == null ? void 0 : _a6.exec(line);
      if (match) {
        index = match.index + match[0].length;
      }
    } else {
      const match =
        (_b = context.options.line) == null ? void 0 : _b.exec(line);
      if (match) {
        index = match.index + match[0].length;
      }
    }
    ...
    if (whitespaceEnd >= line.length) {
      ...
      if (tagMatch) {
        ...
        const end = Position.create(
          currentLine,
          currentCharacter + index + fullMatch.length,
        );
        tokens.push({
          type: 'tag',
          content: value,
    ...
    for (const match of tags) {
      ...
      tokens.push({
        ...
        range: Range.create(
          ...
          Position.create(
            lineIndex,
            lastIndex + offset + tagName.length + characterIndex,
          ),
        ),
      });
      ...
      if (match.length === 4) {
        ...
        tokens.push({
          ...
          range: Range.create(
            ...
            Position.create(
              lineIndex,
              lastIndex + offset + value.length + characterIndex,
            ),
          ),
        });
      } else {
    ...
    if (endContent.length > 0) {
      tokens.push({
        ...
        range: Range.create(
          ...
          Position.create(
            lineIndex,
            lastIndex + characterIndex + endContent.length,
          ),
        ),
      });
    }
...
function parseJSDocComment(context) {
  ...
  const start =
    ((_a6 = elements[0]) == null ? void 0 : _a6.range.start) ?? startPosition;
  const end =
    ((_b = elements[elements.length - 1]) == null ? void 0 : _b.range.end) ??
    startPosition;
...
function parseJSDocText(context) {
  ...
  return new JSDocTextImpl(
    lines,
    Range.create(firstToken.range.start, lastToken.range.end),
  );
}
...
function normalizeOption(option2, start) {
  if (typeof option2 === 'string' || typeof option2 === 'object') {
    const escaped =
      typeof option2 === 'string' ? escapeRegExp(option2) : option2.source;
    if (start) {
...
${content}`;
  ...
  toMarkdown(options) {
    var _a6;
    return (
      ((_a6 = options == null ? void 0 : options.renderTag) == null
        ? void 0
        : _a6.call(options, this)) ?? this.toMarkdownDefault(options)
    );
  }
  toMarkdownDefault(options) {
    ...
    let marker = '';
    if (
      (options == null ? void 0 : options.tag) === 'italic' ||
      (options == null ? void 0 : options.tag) === void 0
    ) {
      marker = '*';
...
function renderInlineTag(tag, content, options) {
  ...
  if (tag === 'linkplain' || tag === 'linkcode' || tag === 'link') {
    ...
    const renderedLink =
      ((_a6 = options.renderLink) == null
        ? void 0
        : _a6.call(options, content, display)) ??
      renderLinkDefault(content, display);
    return renderedLink;
  }
  return void 0;
}
...
var JSDocDocumentationProvider = class {
  ...
  documentationLinkRenderer(node, name, display) {
    const description =
      this.findNameInLocalSymbols(node, name) ??
      this.findNameInGlobalScope(node, name);
  ...
  findNameInGlobalScope(node, name) {
    const description = this.indexManager
      .allElements()
      .find((e) => e.name === name);
    return description;
  }
...
var DefaultWorkspaceLock = class {
  constructor() {
    this.previousTokenSource =
      new cancellation_exports.CancellationTokenSource();
    this.writeQueue = [];
    this.readQueue = [];
    this.done = true;
  }
  ...
  async performNextOperation() {
    ...
    this.done = false;
    await Promise.all(
      entries.map(async ({ action, deferred, cancellationToken }) => {
        try {
...
var DefaultHydrator = class {
  ...
  dehydrate(result) {
    return {
      ...
      lexerReport: result.lexerReport
        ? this.dehydrateLexerReport(result.lexerReport)
        : void 0,
      ...
      value: this.dehydrateAstNode(
        result.value,
        this.createDehyrationContext(result.value),
      ),
    };
  }
  ...
  dehydrateCstNode(node, context) {
    ...
    if (isCompositeCstNode(node)) {
      cstNode.content = node.content.map((child) =>
        this.dehydrateCstNode(child, context),
      );
    ...
    for (const [name, value] of Object.entries(node)) {
      ...
      if (Array.isArray(value)) {
        ...
        for (const item of value) {
          if (isAstNode(item)) {
            arr.push(
              this.setParent(this.hydrateAstNode(item, context), astNode),
            );
          } else if (isReference(item)) {
        ...
        astNode[name] = this.setParent(
          this.hydrateAstNode(value, context),
          astNode,
        );
      } else if (isReference(value)) {
  ...
  hydrateReference(reference, node, name, context) {
    return this.linker.buildReference(
      node,
      name,
      context.cstNodes.get(reference.$refNode),
      reference.$refText,
    );
  }
...
var IndentationAwareTokenBuilder = class extends DefaultTokenBuilder {
  ...
  indentMatcher(text, offset, tokens, groups) {
    ...
    const { currIndentLevel, prevIndentLevel, match } = this.matchWhitespace(
      text,
      offset,
      tokens,
      groups,
  ...
  dedentMatcher(text, offset, tokens, groups) {
    ...
    if (matchIndentIndex === -1) {
      this.diagnostics.push({
        ...
        offset,
        length:
          ((_a6 = match == null ? void 0 : match[0]) == null
            ? void 0
            : _a6.length) ?? 0,
    ...
    const newlinesBeforeDedent =
      ((_b = text.substring(0, offset).match(/[\r\n]+$/)) == null
        ? void 0
        : _b[0].length) ?? 1;
  ...
  buildTerminalToken(terminal) {
    ...
    const { indentTokenName, dedentTokenName, whitespaceTokenName } =
      this.options;
...
var IndentationAwareLexer = class extends DefaultLexer {
  ...
  tokenize(text, options = DEFAULT_TOKENIZE_OPTIONS) {
    ...
    for (let i = 0; i < length; i++) {
      ...
      if (
        token.tokenTypeIdx === indentTokenIdx &&
        nextToken.tokenTypeIdx === dedentTokenIdx
      ) {
        i++;
        continue;
      }
...
function loadGrammarFromJson(json) {
  ...
  services.shared.workspace.LangiumDocumentFactory.fromModel(
    astNode,
    URI2.parse(`memory:/${astNode.name ?? 'grammar'}.langium`),
  );
  return astNode;
}
...
var DefaultLangiumProfiler = class {
  ...
  createTask(category, taskId) {
    ...
    return new ProfilingTask(
      (record) => this.records.add(category, this.dumpRecord(category, record)),
      taskId,
    );
  }
  dumpRecord(category, record) {
    console.info(
      `Task ${category}.${record.identifier} executed in ${record.duration.toFixed(2)}ms and ended at ${record.date.toISOString()}`,
    );
    const result = [];
    ...
    const taskInternalDuration =
      record.duration -
      result.map((r) => r.duration).reduce((a, b) => a + b, 0);
    result.push({
  ...
  getRecords(...categories) {
    if (categories.length === 0) {
      ...
      return this.records
        .entries()
        .filter((e) => categories.some((c) => c === e[0]))
        .flatMap((e) => e[1]);
    }
  }
};
var ProfilingTask = class {
  ...
  stop() {
    ...
    if (this.stack.length !== 0) {
      throw new Error(
        `Task "${this.identifier}" cannot be stopped before sub-task(s): ${this.stack.map((s) => s.id).join(', ')}.`,
      );
    }
    const record = {
  ...
  stopSubTask(subTaskId) {
    ...
    if (!subStack) {
      throw new Error(
        `Task "${this.identifier}.${subTaskId}" was not started.`,
      );
    }
...
var _a;
var MermaidAstReflection =
  ((_a = class extends AbstractAstReflection {
    constructor() {
      super(...arguments);
      this.types = {
        Architecture: {
  ...
  __name(_a, 'MermaidAstReflection'),
  _a);
var reflection2 = new MermaidAstReflection();
var loadedArchitectureGrammarGrammar;
var ArchitectureGrammarGrammar = __name(
  () =>
    loadedArchitectureGrammarGrammar ??
...
var GitGraphGrammarGrammar = __name(
  () =>
    loadedGitGraphGrammarGrammar ??
    (loadedGitGraphGrammarGrammar = loadGrammarFromJson(
...
var InfoGrammarGrammar = __name(
  () =>
    loadedInfoGrammarGrammar ??
    (loadedInfoGrammarGrammar = loadGrammarFromJson(
...
var PacketGrammarGrammar = __name(
  () =>
    loadedPacketGrammarGrammar ??
    (loadedPacketGrammarGrammar = loadGrammarFromJson(
...
var PieGrammarGrammar = __name(
  () =>
    loadedPieGrammarGrammar ??
    (loadedPieGrammarGrammar = loadGrammarFromJson(
...
var RadarGrammarGrammar = __name(
  () =>
    loadedRadarGrammarGrammar ??
    (loadedRadarGrammarGrammar = loadGrammarFromJson(
...
var TreemapGrammarGrammar = __name(
  () =>
    loadedTreemapGrammarGrammar ??
    (loadedTreemapGrammarGrammar = loadGrammarFromJson(
...
var _a2;
var AbstractMermaidValueConverter =
  ((_a2 = class extends DefaultValueConverter {
    runConverter(rule, input, cstNode) {
  ...
  __name(_a2, 'AbstractMermaidValueConverter'),
  _a2);
var _a3;
var CommonValueConverter =
  ((_a3 = class extends AbstractMermaidValueConverter {
    runCustomConverter(_rule, _input, _cstNode) {
      return void 0;
    }
  }),
  __name(_a3, 'CommonValueConverter'),
  _a3);
var _a4;
var AbstractMermaidTokenBuilder =
  ((_a4 = class extends DefaultTokenBuilder {
    constructor(keywords) {
      super();
      this.keywords = new Set(keywords);
    }
    buildKeywordTokens(rules, terminalTokens, options) {
      const tokenTypes = super.buildKeywordTokens(
        rules,
        terminalTokens,
        options,
      );
  ...
  __name(_a4, 'AbstractMermaidTokenBuilder'),
  _a4);
var _a5;
var CommonTokenBuilder =
  ((_a5 = class extends AbstractMermaidTokenBuilder {}),
  __name(_a5, 'CommonTokenBuilder'),
  _a5);
...
//# sourceMappingURL=chunk-5SMYMPSU.js.map
