...
function s(s2, n2, o2, a2 = 1) {
  ...
  const l2 = (function (t2, s3, n3) {
    ...
    for (const s4 of t2) {
      const t3 = [...s4];
      e(t3[0], t3[t3.length - 1]) || t3.push([t3[0][0], t3[0][1]]),
        t3.length > 2 && o3.push(t3);
    }
    const a3 = [];
    s3 = Math.max(s3, 0.1);
    const h3 = [];
    ...
    for (; r3.length || h3.length; ) {
      ...
      if (
        ...
        r3.sort((t3, e2) =>
          t3.edge.x === e2.edge.x
            ? 0
            : (t3.edge.x - e2.edge.x) / Math.abs(t3.edge.x - e2.edge.x),
        ),
...
function n(t2, e2) {
  ...
  return (
    e2.roughness >= 1 &&
      ((null === (n2 = e2.randomizer) || void 0 === n2 ? void 0 : n2.next()) ||
        Math.random()) > 0.7 &&
      (h2 = a2),
    s(t2, a2, o2, h2 || 1)
  );
      ...
      t2.forEach((t3) => {
        ...
        for (let t4 = 0; t4 < h2; t4++) {
          const o3 = 2 * t4 * e2,
            ...
            u2 = [
              i3[0] + h3 * Math.cos(c2 + Math.PI / 4),
              i3[1] + h3 * Math.sin(c2 + Math.PI / 4),
            ];
          n2.push(
    ...
    s2 = (function (t3) {
      ...
      for (; '' !== t3; )
        if (t3.match(/^([ \t\r\n,]+)/)) t3 = t3.substr(RegExp.$1.length);
          ...
          (e3[e3.length] = { type: f, text: RegExp.$1 }),
            (t3 = t3.substr(RegExp.$1.length));
        else {
          if (
            !t3.match(
    ...
    switch (c2) {
      ...
      case 'A': {
        const t3 = Math.abs(l2[0]),
          ...
          c3 = l2[6];
        if (0 === t3 || 0 === s3)
          e2.push({ key: 'C', data: [n2, o2, i3, c3, i3, c3] }),
            (n2 = i3),
            (o2 = c3);
        else if (n2 !== i3 || o2 !== c3) {
...
function w(t2, e2, s2) {
  return [
    t2 * Math.cos(s2) - e2 * Math.sin(s2),
    t2 * Math.sin(s2) + e2 * Math.cos(s2),
  ];
}
...
function S(t2, e2, s2) {
  ...
  return 2 === n2
    ? v(t2[0][0], t2[0][1], t2[1][0], t2[1][1], s2)
    : { type: 'path', ops: [] };
}
...
function L(t2, e2) {
  if (t2.length) {
    const s2 = 'number' == typeof t2[0][0] ? [t2] : t2,
      ...
      o2 = e2.disableMultiStroke
        ? []
        : j(s2[0], 1.5 * (1 + 0.22 * e2.roughness), z(e2));
    for (let t3 = 1; t3 < s2.length; t3++) {
      const a2 = s2[t3];
      if (a2.length) {
        const t4 = j(a2, 1 * (1 + 0.2 * e2.roughness), e2),
          s3 = e2.disableMultiStroke
            ? []
            : j(a2, 1.5 * (1 + 0.22 * e2.roughness), z(e2));
...
function T(t2, e2, s2) {
  const n2 = Math.sqrt(
      2 * Math.PI * Math.sqrt((Math.pow(t2 / 2, 2) + Math.pow(e2 / 2, 2)) / 2),
    ),
    o2 = Math.ceil(
      Math.max(s2.curveStepCount, (s2.curveStepCount / Math.sqrt(200)) * n2),
    ),
    a2 = (2 * Math.PI) / o2;
...
function W(t2) {
  return (
    t2.randomizer || (t2.randomizer = new p(t2.seed || 0)), t2.randomizer.next()
  );
}
...
function q(t2, e2, s2) {
  ...
  if (n2 > 3) {
    ...
    3 === n2
      ...
      : 2 === n2 &&
        o2.push(...R(t2[0][0], t2[0][1], t2[1][0], t2[1][1], s2, true, true));
  return o2;
}
function F(t2, e2, s2, n2, o2, a2, h2, r2) {
  ...
  if (0 === r2.roughness) {
    ...
    for (let h3 = l2; h3 < u2; h3 += t2) {
      const t3 = [
        G(a2, r2) + e2 + n2 * Math.cos(h3),
        G(a2, r2) + s2 + o2 * Math.sin(h3),
      ];
      i2.push(t3), c2.push(t3);
    }
    c2.push([
...
function V(t2, e2, s2, n2, o2, a2, h2, r2, i2) {
  ...
  for (let a3 = c2; a3 <= h2; a3 += t2)
    l2.push([
      G(r2, i2) + e2 + n2 * Math.cos(a3),
      G(r2, i2) + s2 + o2 * Math.sin(a3),
    ]);
  return (
...
function B(t2, e2, s2) {
  ...
  let o2 =
    ((t2[0] - e2[0]) * (s2[0] - e2[0]) + (t2[1] - e2[1]) * (s2[1] - e2[1])) /
    n2;
...
function K(t2, e2, s2, n2) {
  ...
  if (
    ...
    const s3 = t2[e2 + 0];
    if (o2.length) {
      ((a2 = o2[o2.length - 1]), (h2 = s3), Math.sqrt(N(a2, h2))) > 1 &&
        o2.push(s3);
    } else o2.push(s3);
    o2.push(t2[e2 + 3]);
  } else {
...
var et = class {
  ...
  _o(t2) {
    return t2
      ? Object.assign({}, this.defaultOptions, t2)
      : this.defaultOptions;
  }
  _d(t2, e2, s2) {
      ...
      if ('solid' === s2.fillStyle) {
        const e3 = L(
          ...
          Object.assign(Object.assign({}, s2), {
            ...
            roughness: s2.roughness
              ? s2.roughness + s2.fillShapeRoughnessGain
              : 0,
          }),
        );
...
var st = class {
        ...
        case 'path':
          n2.save(),
            ...
            s2.strokeLineDashOffset &&
              (n2.lineDashOffset = s2.strokeLineDashOffset),
  ...
  _drawToContext(t2, e2, s2, n2 = 'nonzero') {
    ...
    for (const n3 of e2.ops) {
      const e3 =
        'number' == typeof s2 && s2 >= 0
          ? n3.data.map((t3) => +t3.toFixed(s2))
          : n3.data;
      switch (n3.op) {
        case 'move':
          t2.moveTo(e3[0], e3[1]);
...
var ot = class {
  ...
  fillSketch(t2, e2, s2) {
    ...
    return (
      ...
      s2.fillLineDash &&
        o2.setAttribute('stroke-dasharray', s2.fillLineDash.join(' ').trim()),
      s2.fillLineDashOffset &&
...
export { at };
//# sourceMappingURL=chunk-5XJNJXN5.js.map
