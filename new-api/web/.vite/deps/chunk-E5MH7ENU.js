...
import { render } from './chunk-NBEFCHMA.js';
import { generateId, utils_default } from './chunk-IPOIRDR2.js';
import {
  clear,
  common_default,
  getAccDescription,
...
var parser = (function () {
  ...
  var lexer = (function () {
    var lexer2 = {
      ...
      conditions: {
        LINE: { rules: [12, 13], inclusive: false },
        struct: {
          rules: [
        ...
        FLOATING_NOTE_ID: { rules: [67], inclusive: false },
        FLOATING_NOTE: { rules: [64, 65, 66], inclusive: false },
        NOTE_TEXT: { rules: [69, 70], inclusive: false },
        NOTE_ID: { rules: [68], inclusive: false },
        NOTE: { rules: [61, 62, 63], inclusive: false },
        STYLEDEF_STYLEOPTS: { rules: [], inclusive: false },
        STYLEDEF_STYLES: { rules: [34], inclusive: false },
        STYLE_IDS: { rules: [], inclusive: false },
        STYLE: { rules: [33], inclusive: false },
        CLASS_STYLE: { rules: [31], inclusive: false },
        CLASS: { rules: [30], inclusive: false },
        CLASSDEFID: { rules: [28], inclusive: false },
        CLASSDEF: { rules: [26, 27], inclusive: false },
        acc_descr_multiline: { rules: [23, 24], inclusive: false },
        acc_descr: { rules: [21], inclusive: false },
        acc_title: { rules: [19], inclusive: false },
        SCALE: { rules: [16, 17, 36, 37], inclusive: false },
        ALIAS: { rules: [], inclusive: false },
        STATE_ID: { rules: [51], inclusive: false },
        STATE_STRING: { rules: [52, 53], inclusive: false },
        FORK_STATE: { rules: [], inclusive: false },
        STATE: {
          rules: [12, 13, 39, 40, 41, 42, 43, 44, 49, 50, 54, 55, 56],
          inclusive: false,
        },
        ID: { rules: [12, 13], inclusive: false },
        INITIAL: {
          rules: [
...
var draw = __name(async function (text, id, _version, diag) {
  ...
  try {
    const links =
      typeof diag.db.getLinks === 'function'
        ? diag.db.getLinks()
        : /* @__PURE__ */ new Map();
    links.forEach((linkInfo, key) => {
      ...
      const allNodes =
        (_a2 = svg.node()) == null ? void 0 : _a2.querySelectorAll('g');
      let matchedElem;
      allNodes == null
        ? void 0
        : allNodes.forEach((g) => {
        ...
        case STMT_RELATION:
          {
            ...
            const edgeData = {
              ...
              style: G_EDGE_STYLE,
              labelStyle: '',
              label: common_default.sanitizeText(
                item.description ?? '',
                getConfig2(),
              ),
...
function getClassesFromDbInfo(dbInfoItem) {
  var _a2;
  return (
    ((_a2 = dbInfoItem == null ? void 0 : dbInfoItem.classes) == null
      ? void 0
      : _a2.join(' ')) ?? ''
  );
}
  ...
  (parent, parsedItem, diagramStates, nodes, edges, altFlag, look, classes) => {
    ...
    if (itemId !== 'root') {
      ...
      if (parsedItem.description) {
        ...
        newNode.description = common_default.sanitizeTextOrArray(
          newNode.description,
          config,
        );
      }
...
var StateDB =
  ((_a = class {
    ...
    addState(
      ...
      if (descr) {
        ...
        descriptions.forEach((des) =>
          this.addDescription(trimmedId, des.trim()),
        );
      }
      if (note) {
        ...
        doc2.note = note;
        doc2.note.text = common_default.sanitizeText(
          doc2.note.text,
          getConfig2(),
        );
      }
    ...
    addRelation(item1, item2, title) {
      if (typeof item1 === 'object' && typeof item2 === 'object') {
        ...
        this.currentDocument.relations.push({
          ...
          id2,
          relationTitle: title
            ? common_default.sanitizeText(title, getConfig2())
            : void 0,
        });
      }
    }
    ...
    setTextStyle(itemId, cssClassName) {
      var _a2, _b;
      (_b = (_a2 = this.getState(itemId)) == null ? void 0 : _a2.textStyles) ==
      null
        ? void 0
...
//# sourceMappingURL=chunk-E5MH7ENU.js.map
