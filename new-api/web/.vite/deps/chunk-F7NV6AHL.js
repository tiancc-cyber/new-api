import { Base, strings } from './chunk-GGEEJJAA.js';
...
var Title = class extends import_react.PureComponent {
  render() {
    ...
    const component =
      strings.HEADING.indexOf(heading) !== -1 ? `h${heading}` : 'h1';
...
Title.propTypes = {
  copyable: import_prop_types.default.oneOfType([
  ...
  link: import_prop_types.default.oneOfType([
    import_prop_types.default.object,
    import_prop_types.default.bool,
  ]),
  ...
  weight: import_prop_types.default.oneOfType([
    import_prop_types.default.oneOf(strings.WEIGHT),
