import { decodeEntities } from './chunk-IPOIRDR2.js';
import {
  common_default,
  getConfig,
  hasKatex,
...
var m = {
  ...
  nextBulletRegex: (l3) =>
    new RegExp(
      `^ {0,${Math.min(3, l3 - 1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`,
    ),
  hrRegex: (l3) =>
    new RegExp(
      `^ {0,${Math.min(3, l3 - 1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`,
    ),
  fencesBeginRegex: (l3) =>
    new RegExp(`^ {0,${Math.min(3, l3 - 1)}}(?:\`\`\`|~~~)`),
  headingBeginRegex: (l3) => new RegExp(`^ {0,${Math.min(3, l3 - 1)}}#`),
  htmlBeginRegex: (l3) =>
    new RegExp(`^ {0,${Math.min(3, l3 - 1)}}<(?:[a-z].*>|!--)`, 'i'),
};
var Re = /^(?:[ \t]*(?:\n|$))+/;
var Te = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/;
var Oe =
...
function V(l3, e) {
  ...
  if (
    (n[0].trim() || n.shift(),
    n.length > 0 &&
      !((_a2 = n.at(-1)) == null ? void 0 : _a2.trim()) &&
      n.pop(),
    e)
  )
...
`),
        ...
        i.loose ||
          (a
            ? (i.loose = true)
            : this.rules.other.doubleBlankLine.test(u) && (a = true));
        let O = null,
          Y;
        this.options.gfm &&
      ...
      for (let p = 0; p < i.items.length; p++)
        if (
          ...
          let u = i.items[p].tokens.filter((g) => g.type === 'space'),
            c =
              u.length > 0 &&
              u.some((g) => this.rules.other.anyLine.test(g.raw));
          i.loose = c;
        }
      if (i.loose)
        for (let p = 0; p < i.items.length; p++) i.items[p].loose = true;
      return i;
    }
  }
  html(e) {
    ...
    if ((t = this.rules.inline.url.exec(e))) {
      ...
      if (t[2] === '@') (n = t[0]), (r = 'mailto:' + n);
        ...
        do
          (i = t[0]),
            (t[0] =
              ((_a2 = this.rules.inline._backpedal.exec(t[0])) == null
                ? void 0
                : _a2[0]) ?? '');
        while (i !== t[0]);
...
`)
      ...
      if ((r = this.tokenizer.code(e))) {
        e = e.substring(r.raw.length);
        let s = t.at(-1);
        (s == null ? void 0 : s.type) === 'paragraph' ||
...
` + r.text),
  ...
  inlineTokens(e, t = []) {
    ...
    n =
      ((_b = (_a2 = this.options.hooks) == null ? void 0 : _a2.emStrongMask) ==
      null
        ? void 0
    ...
    for (; e; ) {
      ...
      let o;
      if (
        (_d = (_c = this.options.extensions) == null ? void 0 : _c.inline) ==
        null
          ? void 0
          : _d.some((u) =>
  ...
  parseMarkdown(e) {
    return (n, r) => {
      ...
      if ((s.hooks && ((s.hooks.options = s), (s.hooks.block = e)), s.async))
        return (async () => {
          let o = s.hooks ? await s.hooks.preprocess(n) : n,
            u = await (
              s.hooks ? await s.hooks.provideLexer() : e ? x.lex : x.lexInline
            )(o, s),
      ...
      try {
        ...
        let p = (s.hooks ? s.hooks.provideLexer() : e ? x.lex : x.lexInline)(
          n,
          s,
        );
...
function splitLineToFitWidthRecursion(
  ...
  if (checkFit(lineWithNextWord)) {
    return splitLineToFitWidthRecursion(
      words,
      checkFit,
      lines,
      lineWithNextWord,
...
function computeDimensionOfText(parentNode, lineHeight, text) {
  ...
  const textDimension =
    (_a2 = testSpan.node()) == null ? void 0 : _a2.getBoundingClientRect();
  if (textDimension) {
    testElement.remove();
  }
  ...
  async (
    ...
    if (useHtmlLabels) {
      const htmlText = markdown
        ...
        : nonMarkdownToHTML(text);
      const decodedReplacedText = await replaceIconSubstring(
        decodeEntities(htmlText),
        config,
      );
...
//# sourceMappingURL=chunk-KS234T37.js.map
