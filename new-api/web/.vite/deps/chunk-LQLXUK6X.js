import { __export, __name, log, setLogLevel } from './chunk-OQUVF2X3.js';
  ...
  _hue2deg: (hue) => {
    ...
    if (match) {
      ...
      switch (unit) {
        ...
        case 'rad':
          return utils_default.channel.clamp.h(
            (parseFloat(number) * 180) / Math.PI,
          );
        case 'turn':
...
var adjustChannel = (color, channel2, amount) => {
  ...
  const amountNext = utils_default.channel.clamp[channel2](
...
var assignWithDepth = __name(
  (dst, src, { depth = 2, clobber = false } = {}) => {
...
var Theme =
  ((_a2 = class {
    ...
    updateColors() {
      ...
      this.tertiaryColor =
        this.tertiaryColor ||
        adjust_default(this.primaryColor, { h: 180, l: 5 });
      this.primaryBorderColor =
        this.primaryBorderColor || mkBorder(this.primaryColor, this.darkMode);
      this.secondaryBorderColor =
        this.secondaryBorderColor ||
        mkBorder(this.secondaryColor, this.darkMode);
      ...
      this.edgeLabelBackground =
        this.edgeLabelBackground ||
        (this.darkMode
          ? darken_default(this.secondaryColor, 30)
          : this.secondaryColor);
      ...
      this.sequenceNumberColor =
        this.sequenceNumberColor || invert_default(this.lineColor);
      ...
      this.activeTaskBkgColor =
        this.activeTaskBkgColor || lighten_default(this.primaryColor, 23);
      ...
      if (this.darkMode) {
        this.rowOdd =
          this.rowOdd || darken_default(this.mainBkg, 5) || '#ffffff';
        this.rowEven = this.rowEven || darken_default(this.mainBkg, 10);
      } else {
        this.rowOdd =
          this.rowOdd || lighten_default(this.mainBkg, 75) || '#ffffff';
      ...
      this.cScale3 =
        this.cScale3 || adjust_default(this.primaryColor, { h: 30 });
      this.cScale4 =
        this.cScale4 || adjust_default(this.primaryColor, { h: 60 });
      this.cScale5 =
        this.cScale5 || adjust_default(this.primaryColor, { h: 90 });
      this.cScale6 =
        this.cScale6 || adjust_default(this.primaryColor, { h: 120 });
      this.cScale7 =
        this.cScale7 || adjust_default(this.primaryColor, { h: 150 });
      this.cScale8 =
        this.cScale8 || adjust_default(this.primaryColor, { h: 210, l: 150 });
      this.cScale9 =
        this.cScale9 || adjust_default(this.primaryColor, { h: 270 });
      this.cScale10 =
        this.cScale10 || adjust_default(this.primaryColor, { h: 300 });
      this.cScale11 =
        this.cScale11 || adjust_default(this.primaryColor, { h: 330 });
      if (this.darkMode) {
      ...
      for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) {
        this['cScaleInv' + i] =
          this['cScaleInv' + i] || invert_default(this['cScale' + i]);
      }
      for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) {
        if (this.darkMode) {
          this['cScalePeer' + i] =
            this['cScalePeer' + i] || lighten_default(this['cScale' + i], 10);
        } else {
          this['cScalePeer' + i] =
            this['cScalePeer' + i] || darken_default(this['cScale' + i], 10);
        }
      }
      ...
      this.pie7 =
        this.pie7 || adjust_default(this.primaryColor, { h: 60, l: -10 });
      this.pie8 =
        this.pie8 || adjust_default(this.primaryColor, { h: -60, l: -10 });
      this.pie9 =
        this.pie9 || adjust_default(this.primaryColor, { h: 120, l: 0 });
      this.pie10 =
        this.pie10 || adjust_default(this.primaryColor, { h: 60, l: -20 });
      this.pie11 =
        this.pie11 || adjust_default(this.primaryColor, { h: -60, l: -20 });
      this.pie12 =
        this.pie12 || adjust_default(this.primaryColor, { h: 120, l: -10 });
      ...
      this.venn2 =
        this.venn2 ?? adjust_default(this.secondaryColor, { l: -30 });
      this.venn3 = this.venn3 ?? adjust_default(this.tertiaryColor, { l: -30 });
      this.venn4 =
        this.venn4 ?? adjust_default(this.primaryColor, { h: 60, l: -30 });
      this.venn5 =
        this.venn5 ?? adjust_default(this.primaryColor, { h: -60, l: -30 });
      this.venn6 =
        this.venn6 ?? adjust_default(this.secondaryColor, { h: 60, l: -30 });
      this.venn7 =
        this.venn7 ?? adjust_default(this.primaryColor, { h: 120, l: -30 });
      this.venn8 =
        this.venn8 ?? adjust_default(this.secondaryColor, { h: 120, l: -30 });
      ...
      this.radar = {
        axisColor:
          ((_a8 = this.radar) == null ? void 0 : _a8.axisColor) ||
          this.lineColor,
        axisStrokeWidth:
          ((_b = this.radar) == null ? void 0 : _b.axisStrokeWidth) || 2,
        axisLabelFontSize:
          ((_c = this.radar) == null ? void 0 : _c.axisLabelFontSize) || 12,
        curveOpacity:
          ((_d = this.radar) == null ? void 0 : _d.curveOpacity) || 0.5,
        curveStrokeWidth:
          ((_e = this.radar) == null ? void 0 : _e.curveStrokeWidth) || 2,
        graticuleColor:
          ((_f = this.radar) == null ? void 0 : _f.graticuleColor) || '#DEDEDE',
        graticuleStrokeWidth:
          ((_g = this.radar) == null ? void 0 : _g.graticuleStrokeWidth) || 1,
        graticuleOpacity:
          ((_h = this.radar) == null ? void 0 : _h.graticuleOpacity) || 0.3,
        legendBoxSize:
          ((_i = this.radar) == null ? void 0 : _i.legendBoxSize) || 12,
        legendFontSize:
          ((_j = this.radar) == null ? void 0 : _j.legendFontSize) || 12,
      };
      ...
      this.quadrant2Fill =
        this.quadrant2Fill ||
        adjust_default(this.primaryColor, { r: 5, g: 5, b: 5 });
      this.quadrant3Fill =
        this.quadrant3Fill ||
        adjust_default(this.primaryColor, { r: 10, g: 10, b: 10 });
      this.quadrant4Fill =
        this.quadrant4Fill ||
        adjust_default(this.primaryColor, { r: 15, g: 15, b: 15 });
      this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor;
      this.quadrant2TextFill =
        this.quadrant2TextFill ||
        adjust_default(this.primaryTextColor, { r: -5, g: -5, b: -5 });
      this.quadrant3TextFill =
        this.quadrant3TextFill ||
        adjust_default(this.primaryTextColor, { r: -10, g: -10, b: -10 });
      this.quadrant4TextFill =
        this.quadrant4TextFill ||
        adjust_default(this.primaryTextColor, { r: -15, g: -15, b: -15 });
      ...
      this.xyChart = {
        backgroundColor:
          ((_k = this.xyChart) == null ? void 0 : _k.backgroundColor) ||
          this.background,
        titleColor:
          ((_l = this.xyChart) == null ? void 0 : _l.titleColor) ||
          this.primaryTextColor,
        xAxisTitleColor:
          ((_m = this.xyChart) == null ? void 0 : _m.xAxisTitleColor) ||
          this.primaryTextColor,
        xAxisLabelColor:
          ((_n = this.xyChart) == null ? void 0 : _n.xAxisLabelColor) ||
          this.primaryTextColor,
        xAxisTickColor:
          ((_o = this.xyChart) == null ? void 0 : _o.xAxisTickColor) ||
          this.primaryTextColor,
        xAxisLineColor:
          ((_p = this.xyChart) == null ? void 0 : _p.xAxisLineColor) ||
          this.primaryTextColor,
        yAxisTitleColor:
          ((_q = this.xyChart) == null ? void 0 : _q.yAxisTitleColor) ||
          this.primaryTextColor,
        yAxisLabelColor:
          ((_r = this.xyChart) == null ? void 0 : _r.yAxisLabelColor) ||
          this.primaryTextColor,
        yAxisTickColor:
          ((_s = this.xyChart) == null ? void 0 : _s.yAxisTickColor) ||
          this.primaryTextColor,
        yAxisLineColor:
          ((_t = this.xyChart) == null ? void 0 : _t.yAxisLineColor) ||
          this.primaryTextColor,
        plotColorPalette:
...
var Theme2 =
  ((_a3 = class {
    constructor() {
      ...
      this.rowOdd =
        this.rowOdd || lighten_default(this.mainBkg, 5) || '#ffffff';
      this.rowEven = this.rowEven || darken_default(this.mainBkg, 10);
    ...
    updateColors() {
      ...
      this.cScale7 =
        this.cScale7 || adjust_default(this.primaryColor, { h: 150 });
      this.cScale8 =
        this.cScale8 || adjust_default(this.primaryColor, { h: 210 });
      this.cScale9 =
        this.cScale9 || adjust_default(this.primaryColor, { h: 270 });
      this.cScale10 =
        this.cScale10 || adjust_default(this.primaryColor, { h: 300 });
      ...
      for (let i = 0; i < 5; i++) {
        this['surface' + i] =
          this['surface' + i] ||
          adjust_default(this.mainBkg, { h: 30, s: -30, l: -(-10 + i * 4) });
        this['surfacePeer' + i] =
          this['surfacePeer' + i] ||
      ...
      for (let i = 0; i < 8; i++) {
        this['venn' + (i + 1)] =
          this['venn' + (i + 1)] ?? lighten_default(this['cScale' + i], 30);
      }
      this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor;
      this.vennSetTextColor = this.vennSetTextColor ?? this.textColor;
      this.quadrant1Fill = this.quadrant1Fill || this.primaryColor;
      ...
      this.xyChart = {
        backgroundColor:
          ((_a8 = this.xyChart) == null ? void 0 : _a8.backgroundColor) ||
          this.background,
        titleColor:
          ((_b = this.xyChart) == null ? void 0 : _b.titleColor) ||
          this.primaryTextColor,
        xAxisTitleColor:
          ((_c = this.xyChart) == null ? void 0 : _c.xAxisTitleColor) ||
          this.primaryTextColor,
        xAxisLabelColor:
          ((_d = this.xyChart) == null ? void 0 : _d.xAxisLabelColor) ||
          this.primaryTextColor,
        xAxisTickColor:
          ((_e = this.xyChart) == null ? void 0 : _e.xAxisTickColor) ||
          this.primaryTextColor,
        xAxisLineColor:
          ((_f = this.xyChart) == null ? void 0 : _f.xAxisLineColor) ||
          this.primaryTextColor,
        yAxisTitleColor:
          ((_g = this.xyChart) == null ? void 0 : _g.yAxisTitleColor) ||
          this.primaryTextColor,
        yAxisLabelColor:
          ((_h = this.xyChart) == null ? void 0 : _h.yAxisLabelColor) ||
          this.primaryTextColor,
        yAxisTickColor:
          ((_i = this.xyChart) == null ? void 0 : _i.yAxisTickColor) ||
          this.primaryTextColor,
        yAxisLineColor:
          ((_j = this.xyChart) == null ? void 0 : _j.yAxisLineColor) ||
          this.primaryTextColor,
        plotColorPalette:
      ...
      this.radar = {
        axisColor:
          ((_l = this.radar) == null ? void 0 : _l.axisColor) || this.lineColor,
        axisStrokeWidth:
          ((_m = this.radar) == null ? void 0 : _m.axisStrokeWidth) || 2,
        axisLabelFontSize:
          ((_n = this.radar) == null ? void 0 : _n.axisLabelFontSize) || 12,
        curveOpacity:
          ((_o = this.radar) == null ? void 0 : _o.curveOpacity) || 0.5,
        curveStrokeWidth:
          ((_p = this.radar) == null ? void 0 : _p.curveStrokeWidth) || 2,
        graticuleColor:
          ((_q = this.radar) == null ? void 0 : _q.graticuleColor) || '#DEDEDE',
        graticuleStrokeWidth:
          ((_r = this.radar) == null ? void 0 : _r.graticuleStrokeWidth) || 1,
        graticuleOpacity:
          ((_s = this.radar) == null ? void 0 : _s.graticuleOpacity) || 0.3,
        legendBoxSize:
          ((_t = this.radar) == null ? void 0 : _t.legendBoxSize) || 12,
        legendFontSize:
          ((_u = this.radar) == null ? void 0 : _u.legendFontSize) || 12,
      };
      ...
      this.git3 = lighten_default(
        this.pie4 || adjust_default(this.primaryColor, { h: -30 }),
        20,
      );
      this.git4 = lighten_default(
        this.pie5 || adjust_default(this.primaryColor, { h: -60 }),
        20,
      );
      this.git5 = lighten_default(
        this.pie6 || adjust_default(this.primaryColor, { h: -90 }),
        10,
      );
      this.git6 = lighten_default(
        this.pie7 || adjust_default(this.primaryColor, { h: 60 }),
        10,
      );
      this.git7 = lighten_default(
        this.pie8 || adjust_default(this.primaryColor, { h: 120 }),
        20,
      );
      this.gitInv0 = this.gitInv0 || invert_default(this.git0);
      this.gitInv1 = this.gitInv1 || invert_default(this.git1);
      ...
      this.gitBranchLabel0 =
        this.gitBranchLabel0 || invert_default(this.labelTextColor);
      this.gitBranchLabel1 = this.gitBranchLabel1 || this.labelTextColor;
      this.gitBranchLabel2 = this.gitBranchLabel2 || this.labelTextColor;
      this.gitBranchLabel3 =
        this.gitBranchLabel3 || invert_default(this.labelTextColor);
      ...
      this.attributeBackgroundColorOdd =
        this.attributeBackgroundColorOdd ||
        lighten_default(this.background, 12);
      this.attributeBackgroundColorEven =
        this.attributeBackgroundColorEven ||
        lighten_default(this.background, 2);
  ...
  ((_a4 = class {
    ...
    updateColors() {
      ...
      this.cScale11 =
        this.cScale11 || adjust_default(this.primaryColor, { h: 330 });
      this['cScalePeer1'] =
        this['cScalePeer1'] || darken_default(this.secondaryColor, 45);
      this['cScalePeer2'] =
        this['cScalePeer2'] || darken_default(this.tertiaryColor, 40);
      for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) {
        this['cScale' + i] = darken_default(this['cScale' + i], 10);
        this['cScalePeer' + i] =
          this['cScalePeer' + i] || darken_default(this['cScale' + i], 25);
      }
      for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) {
        this['cScaleInv' + i] =
          this['cScaleInv' + i] ||
          adjust_default(this['cScale' + i], { h: 180 });
      }
      for (let i = 0; i < 5; i++) {
        this['surface' + i] =
          this['surface' + i] ||
          adjust_default(this.mainBkg, { h: 30, l: -(5 + i * 5) });
        this['surfacePeer' + i] =
          this['surfacePeer' + i] ||
          adjust_default(this.mainBkg, { h: 30, l: -(7 + i * 5) });
      }
      this.scaleLabelColor =
      ...
      if (this.labelTextColor !== 'calculated') {
        this.cScaleLabel0 =
          this.cScaleLabel0 || invert_default(this.labelTextColor);
        this.cScaleLabel3 =
          this.cScaleLabel3 || invert_default(this.labelTextColor);
        for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) {
          this['cScaleLabel' + i] =
            this['cScaleLabel' + i] || this.labelTextColor;
        }
      }
      this.nodeBkg = this.mainBkg;
      this.nodeBorder = this.border1;
      ...
      this.archEdgeArrowColor = this.lineColor;
      this.rowOdd =
        this.rowOdd || lighten_default(this.primaryColor, 75) || '#ffffff';
      ...
      this.pie7 =
        this.pie7 || adjust_default(this.primaryColor, { h: 60, l: -20 });
      this.pie8 =
        this.pie8 || adjust_default(this.primaryColor, { h: -60, l: -40 });
      this.pie9 =
        this.pie9 || adjust_default(this.primaryColor, { h: 120, l: -40 });
      this.pie10 =
        this.pie10 || adjust_default(this.primaryColor, { h: 60, l: -40 });
      this.pie11 =
        this.pie11 || adjust_default(this.primaryColor, { h: -90, l: -40 });
      this.pie12 =
        this.pie12 || adjust_default(this.primaryColor, { h: 120, l: -30 });
      this.pieTitleTextSize = this.pieTitleTextSize || '25px';
      this.pieTitleTextColor = this.pieTitleTextColor || this.taskTextDarkColor;
      this.pieSectionTextSize = this.pieSectionTextSize || '17px';
      this.pieSectionTextColor = this.pieSectionTextColor || this.textColor;
      ...
      this.gitInv0 =
        this.gitInv0 || darken_default(invert_default(this.git0), 25);
      this.gitInv1 = this.gitInv1 || invert_default(this.git1);
      this.gitInv2 = this.gitInv2 || invert_default(this.git2);
      this.gitInv3 = this.gitInv3 || invert_default(this.git3);
      this.gitInv4 = this.gitInv4 || invert_default(this.git4);
  ...
  ((_a5 = class {
    ...
    updateColors() {
      ...
      for (let i = 0; i < 5; i++) {
        this['surface' + i] =
          this['surface' + i] ||
          adjust_default(this.mainBkg, { h: 30, s: -30, l: -(5 + i * 5) });
        this['surfacePeer' + i] =
          this['surfacePeer' + i] ||
      ...
      this.pie5 = this.pie5 || adjust_default(this.secondaryColor, { l: -30 });
      this.pie6 =
        this.pie6 || adjust_default(this.tertiaryColor, { h: 40, l: -40 });
      this.pie7 =
        this.pie7 || adjust_default(this.primaryColor, { h: 60, l: -10 });
      this.pie8 =
        this.pie8 || adjust_default(this.primaryColor, { h: -60, l: -10 });
      this.pie9 =
        this.pie9 || adjust_default(this.primaryColor, { h: 120, l: 0 });
      this.pie10 =
        this.pie10 || adjust_default(this.primaryColor, { h: 60, l: -50 });
      this.pie11 =
        this.pie11 || adjust_default(this.primaryColor, { h: -60, l: -50 });
      this.pie12 =
        this.pie12 || adjust_default(this.primaryColor, { h: 120, l: -50 });
      this.pieTitleTextSize = this.pieTitleTextSize || '25px';
      this.pieTitleTextColor = this.pieTitleTextColor || this.taskTextDarkColor;
      this.pieSectionTextSize = this.pieSectionTextSize || '17px';
      this.pieSectionTextColor = this.pieSectionTextColor || this.textColor;
  ...
  ((_a6 = class {
    ...
    updateColors() {
      ...
      for (let i = 0; i < 5; i++) {
        this['surface' + i] =
          this['surface' + i] ||
          adjust_default(this.mainBkg, { l: -(5 + i * 5) });
        this['surfacePeer' + i] =
          this['surfacePeer' + i] ||
          adjust_default(this.mainBkg, { l: -(8 + i * 5) });
      }
      this.nodeBkg = this.mainBkg;
      this.nodeBorder = this.border1;
      this.clusterBkg = this.secondBkg;
...
var updateCurrentConfig = __name((siteCfg, _directives) => {
  ...
  if (sumOfDirectives.theme && sumOfDirectives.theme in themes_default) {
    const tmpConfigFromInitialize = assignWithDepth_default(
      {},
    ...
    if (cfg.theme && cfg.theme in themes_default) {
      cfg.themeVariables =
        themes_default[cfg.theme].getThemeVariables(themeVariables);
    }
  }
  currentConfig = cfg;
...
var addDirective = __name((directive) => {
  ...
  if (
    ...
    !((_a8 = directive.themeVariables) == null ? void 0 : _a8.fontFamily)
  ) {
...
var getEffectiveHtmlLabels = __name((config2) => {
  ...
  return evaluate(
    config2.htmlLabels ??
      ((_b = config2.flowchart) == null ? void 0 : _b.htmlLabels) ??
      true,
  );
...
var sanitizeText = __name((text2, config2) => {
  ...
  if (config2.dompurifyConfig) {
    text2 = purify
      .sanitize(sanitizeMore(text2, config2), config2.dompurifyConfig)
      .toString();
  } else {
    text2 = purify
...
var hasKatex = __name((text2) => {
  var _a8;
  return (
    (((_a8 = text2.match(katexRegex)) == null ? void 0 : _a8.length) ?? 0) > 0
  );
}, 'hasKatex');
...
var renderKatexUnsanitized = __name(async (text2, config2) => {
  ...
  if (
    !(isMathMLSupported() || config2.legacyMathML || config2.forceLegacyMathML)
  ) {
  ...
  if (true) {
    const { default: katex } = await import('./katex-ZVP3U3DI.js');
    const outputMode =
      config2.forceLegacyMathML ||
      (!isMathMLSupported() && config2.legacyMathML)
        ? 'htmlAndMathml'
        : 'mathml';
    return text2
...
var diagramTitle = '';
var accDescription = '';
var sanitizeText2 = __name(
  (txt) => sanitizeText(txt, getConfig()),
  'sanitizeText',
);
var clear = __name(() => {
  accTitle = '';
...
var sanitizeText3 = __name(
  (text2) => sanitizeText(text2, getConfig2()),
  'sanitizeText',
);
...
var DiagramNotFoundError =
  ((_a7 = class extends Error {
    constructor(name) {
      super(`Diagram ${name} not found.`);
    }
  }),
  __name(_a7, 'DiagramNotFoundError'),
  _a7);
...
*/
//# sourceMappingURL=chunk-LQLXUK6X.js.map
