...
var isDescendant = __name((id, ancestorId) => {
  ...
  log.trace(
    ...
    id,
    ' = ',
    ancestorDescendants.includes(id),
  );
...
var findCommonEdges = __name((graph, id1, id2) => {
  ...
  const result = edges1Prim.filter((edgeIn1) => {
    return edges2Prim.some(
      (edge) => edgeIn1.v === edge.v && edgeIn1.w === edge.w,
    );
  });
  return result;
}, 'findCommonEdges');
...
var adjustClustersAndEdges = __name((graph, depth) => {
  ...
  for (let id of clusterDb.keys()) {
    ...
    if (
      ...
      !clusterDb.get(parent).externalConnections
    ) {
...
var extractor = __name((graph, depth) => {
  ...
  for (const node of nodes) {
    ...
    if (!clusterDb.has(node)) {
      ...
      if (
        (_b = (_a = clusterDb.get(node)) == null ? void 0 : _a.clusterData) ==
        null
          ? void 0
          : _b.dir
      ) {
...
var recursiveRender = __name(
  async (_elem, graph, diagramType, id, parentCluster, siteConfig) => {
      ...
      sortNodesByHierarchy(graph).map(async function (v) {
        ...
        if (node == null ? void 0 : node.clusterNode) {
          ...
          if (graph.children(v).length > 0) {
            ...
            const labelHeight =
              ((_a = node == null ? void 0 : node.labelBBox) == null
                ? void 0
                : _a.height) || 0;
  ...
  const graph = new Graph({
    ...
    .setGraph({
      ...
      nodesep:
        ...
        ((_c = (_b = data4Layout.config) == null ? void 0 : _b.flowchart) ==
        null
          ? void 0
          : _c.nodeSpacing) ||
      ...
      ranksep:
        ...
        ((_f = (_e = data4Layout.config) == null ? void 0 : _e.flowchart) ==
        null
          ? void 0
          : _f.rankSpacing) ||
...
export { render };
//# sourceMappingURL=dagre-KLK3FWXG-BJOTLAIH.js.map
