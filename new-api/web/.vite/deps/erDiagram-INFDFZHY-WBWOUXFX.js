...
import { __export, __name, log, select_default } from './chunk-OQUVF2X3.js';
...
var parser = (function () {
  ...
  var lexer = (function () {
    var lexer2 = {
      ...
      conditions: {
        style: { rules: [34, 35, 36, 37, 38, 73, 74], inclusive: false },
  ...
  ((_a = class {
    ...
    addEntity(name, alias = '') {
      ...
      if (!this.entities.has(name)) {
        ...
        !((_a2 = this.entities.get(name)) == null ? void 0 : _a2.alias) &&
        alias
      ) {
...
var draw = __name(async function (text, id, _version, diag) {
  ...
  data4Layout.config.flowchart.nodeSpacing =
    (conf == null ? void 0 : conf.nodeSpacing) || 140;
  data4Layout.config.flowchart.rankSpacing =
    (conf == null ? void 0 : conf.rankSpacing) || 80;
...
export { diagram };
//# sourceMappingURL=erDiagram-INFDFZHY-WBWOUXFX.js.map
