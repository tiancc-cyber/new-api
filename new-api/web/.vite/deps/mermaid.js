...
import { registerLayoutLoaders } from './chunk-NBEFCHMA.js';
import './chunk-I2HSE6D7.js';
import './chunk-P32SJDBU.js';
import './chunk-5XJNJXN5.js';
import './chunk-RK4ST7HX.js';
import './chunk-2WVMAWKR.js';
import './chunk-GCN5RWLQ.js';
import { dedent, registerIconPacks } from './chunk-KS234T37.js';
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
import { __name, log, select_default, setLogLevel } from './chunk-OQUVF2X3.js';
import { compile, serialize, stringify } from './chunk-RMLN643Q.js';
...
var detector = __name((txt) => {
  return /^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/.test(
    txt,
  );
}, 'detector');
var loader = __name(async () => {
  const { diagram: diagram2 } = await import(
    './c4Diagram-IC4MRINW-DI23XC3J.js'
  );
...
var detector2 = __name((txt, config) => {
  ...
  if (
    ((_a2 = config == null ? void 0 : config.flowchart) == null
      ? void 0
      : _a2.defaultRenderer) === 'dagre-wrapper' ||
    ((_b = config == null ? void 0 : config.flowchart) == null
      ? void 0
      : _b.defaultRenderer) === 'elk'
  ) {
    return false;
  }
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './flowDiagram-PKNHOUZH-YQL22ML7.js'
  );
...
var detector3 = __name((txt, config) => {
  ...
  if (
    /^\s*graph/.test(txt) &&
    ((_c = config == null ? void 0 : config.flowchart) == null
      ? void 0
      : _c.defaultRenderer) === 'dagre-wrapper'
  ) {
    return true;
  }
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './erDiagram-INFDFZHY-WBWOUXFX.js'
  );
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './gitGraphDiagram-K3NZZRJ6-JLYOFOEX.js'
  );
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './ganttDiagram-A5KZAMGK-DMIIDMED.js'
  );
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './infoDiagram-LFFYTUFH-Q3GW54F5.js'
  );
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './pieDiagram-SKSYHLDU-BELIWXTK.js'
  );
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './quadrantDiagram-337W2JSQ-JSR6ILKS.js'
  );
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './xychartDiagram-JWTSCODW-QRB2UESO.js'
  );
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './requirementDiagram-Z7DCOOCP-KD6AX7XT.js'
  );
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './sequenceDiagram-2WXFIKYE-IZH6EB5B.js'
  );
...
var detector13 = __name((txt, config) => {
  var _a2;
  if (
    ((_a2 = config == null ? void 0 : config.class) == null
      ? void 0
      : _a2.defaultRenderer) === 'dagre-wrapper'
  ) {
    return false;
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './classDiagram-VBA2DB6C-KP7NS5M4.js'
  );
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './classDiagram-v2-RAHNMMFH-KOVNIVBR.js'
  );
...
var detector15 = __name((txt, config) => {
  var _a2;
  if (
    ((_a2 = config == null ? void 0 : config.state) == null
      ? void 0
      : _a2.defaultRenderer) === 'dagre-wrapper'
  ) {
    return false;
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './stateDiagram-RAJIS63D-ITI3BU2F.js'
  );
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './stateDiagram-v2-FVOUBMTO-VPREWSFL.js'
  );
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './journeyDiagram-4ABVD52K-5XDKLTJE.js'
  );
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './timeline-definition-YZTLITO2-HX7C3KO4.js'
  );
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './mindmap-definition-YRQLILUH-3MH2LOWV.js'
  );
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './kanban-definition-K7BYSVSG-6C7NVZPY.js'
  );
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './sankeyDiagram-WA2Y5GQK-ST64I4JU.js'
  );
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import('./diagram-P4PSJMXO-PYVWT4BC.js');
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import('./diagram-IFDJBPK2-YGMFTLIS.js');
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './blockDiagram-WCTKOSBZ-3CBYDROA.js'
  );
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './architectureDiagram-2XIMDMQ5-MSHYOR4V.js'
  );
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './ishikawaDiagram-PHBUUO56-RK5SJRDD.js'
  );
...
var loader28 = __name(async () => {
  const { diagram: diagram2 } = await import(
    './vennDiagram-LZ73GAT5-6XV2EVPB.js'
  );
...
var loader29 = __name(async () => {
  const { diagram: diagram2 } = await import('./diagram-E7M64L7V-LVXVMMJ5.js');
...
var loadRegisteredDiagrams = __name(async () => {
  ...
  const results = await Promise.allSettled(
    Object.entries(detectors).map(
      async ([key, { detector: detector30, loader: loader30 }]) => {
        if (!loader30) {
          return;
        }
        try {
...
var Diagram =
  ((_a = class {
    ...
    static async fromText(text, metadata = {}) {
      ...
      if (metadata.title) {
        (_b = db.setDiagramTitle) == null
          ? void 0
          : _b.call(db, metadata.title);
      }
...
var processDirectives = __name((code) => {
  ...
  if (Array.isArray(wrapDirectives)) {
    ...
    (wrapDirectives == null ? void 0 : wrapDirectives.type) === 'wrap'
  ) {
...
function toBase64(str) {
  ...
  const utf8Str = Array.from(utf8Bytes, (byte) =>
...
var createCssStyles = __name(
  (config, classDefs = /* @__PURE__ */ new Map()) => {
    let cssStyles = '';
      ...
      classDefs.forEach((styleClassDef) => {
        ...
        if (!isEmpty_default(styleClassDef.textStyles)) {
          cssStyles += cssImportantStyles(
            ...
            'tspan',
            (
              (styleClassDef == null ? void 0 : styleClassDef.textStyles) || []
...
var cleanUpSvgCode = __name(
  (svgCode = '', inSandboxMode, useArrowMarkerUrls) => {
...
var putIntoIFrame = __name((svgCode = '', svgElement) => {
  ...
  const height = (
    (_b =
      (_a2 = svgElement == null ? void 0 : svgElement.viewBox) == null
        ? void 0
        : _a2.baseVal) == null
      ? void 0
      : _b.height
...
var appendDivSvgG = __name(
  (parentRoot, id30, enclosingDivId, divStyle, svgXlink) => {
...
var render = __name(async function (id30, text, svgContainingElement) {
  ...
  if (
    text.length >
    ((config == null ? void 0 : config.maxTextSize) ?? MAX_TEXTLENGTH)
  ) {
  ...
  if (svgContainingElement !== void 0) {
    ...
    if (isSandboxed) {
      const iframe = sandboxedIframe(
        select_default(svgContainingElement),
        iFrameID,
      );
  ...
  const diagramClassDefs =
    (_b = (_a2 = diag.renderer).getClasses) == null
      ? void 0
      : _b.call(_a2, text, diag);
  ...
  const a11yTitle =
    (_d = (_c = diag.db).getAccTitle) == null ? void 0 : _d.call(_c);
  const a11yDescr =
    (_f = (_e = diag.db).getAccDescription) == null ? void 0 : _f.call(_e);
  ...
  svgCode = cleanUpSvgCode(
    svgCode,
    isSandboxed,
    evaluate(config.arrowMarkerAbsolute),
  );
  if (isSandboxed) {
...
function initialize(userOptions = {}) {
  ...
  if (
    ...
    options.theme in themes_default
  ) {
    options.themeVariables = themes_default[options.theme].getThemeVariables(
      options.themeVariables,
    );
  } else if (options) {
    options.themeVariables = themes_default.default.getThemeVariables(
      options.themeVariables,
    );
  }
  const config =
    typeof options === 'object' ? setSiteConfig(options) : getSiteConfig();
...
var registerExternalDiagrams = __name(
  async (diagrams, { lazyLoad = true } = {}) => {
    addDiagrams();
...
var contentLoaded = __name(function () {
  if (mermaid.startOnLoad) {
    ...
    if (startOnLoad) {
      mermaid
        .run()
        .catch((err) => log.error('Mermaid failed to initialize', err));
    }
  }
}, 'contentLoaded');
