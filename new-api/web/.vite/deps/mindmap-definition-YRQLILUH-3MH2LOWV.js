...
function v35(version, hash, value, namespace, buf, offset) {
  ...
  const namespaceBytes =
    typeof namespace === 'string' ? parse_default(namespace) : namespace;
...
function v4(options, buf, offset) {
  ...
  const rnds =
    options.random ??
    ((_a2 = options.rng) == null ? void 0 : _a2.call(options)) ??
    rng();
  if (rnds.length < 16) {
...
var draw = __name(async (text, id, _version, diagObj) => {
  ...
  data4Layout.layoutAlgorithm = getRegisteredLayoutAlgorithm(
    data4Layout.config.layout,
    {
...
export { diagram };
//# sourceMappingURL=mindmap-definition-YRQLILUH-3MH2LOWV.js.map
