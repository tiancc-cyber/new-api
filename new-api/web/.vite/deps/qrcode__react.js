...
((qrcodegen2) => {
    ...
    getPenaltyScore() {
      ...
      for (let y = 0; y < this.size; y++) {
        ...
        for (let x = 0; x < this.size; x++) {
          if (this.modules[y][x] == runColor) {
            runX++;
            if (runX == 5) result += _QrCode2.PENALTY_N1;
      ...
      for (let x = 0; x < this.size; x++) {
        ...
        for (let y = 0; y < this.size; y++) {
          if (this.modules[y][x] == runColor) {
            runY++;
            if (runY == 5) result += _QrCode2.PENALTY_N1;
  ...
  const _QrSegment = class _QrSegment2 {
    ...
    static makeSegments(text) {
      ...
      else return [_QrSegment2.makeBytes(_QrSegment2.toUtf8ByteArray(text))];
    }
...
var QRCodeCanvas = import_react.default.forwardRef(
  function QRCodeCanvas2(props, forwardedRef) {
    ...
    const [isImgLoaded, setIsImageLoaded] =
      import_react.default.useState(false);
