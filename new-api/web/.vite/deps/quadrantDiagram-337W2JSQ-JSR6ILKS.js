...
import { __name, linear, log, select_default } from './chunk-OQUVF2X3.js';
  ...
  ((_a = class {
    ...
    getDefaultConfig() {
      ...
      return {
        ...
        showTitle: true,
        chartHeight:
          ((_a3 = defaultConfig_default.quadrantChart) == null
            ? void 0
            : _a3.chartWidth) || 500,
        chartWidth:
          ((_b = defaultConfig_default.quadrantChart) == null
            ? void 0
            : _b.chartHeight) || 500,
        titlePadding:
          ((_c = defaultConfig_default.quadrantChart) == null
            ? void 0
            : _c.titlePadding) || 10,
        titleFontSize:
          ((_d = defaultConfig_default.quadrantChart) == null
            ? void 0
            : _d.titleFontSize) || 20,
        quadrantPadding:
          ((_e = defaultConfig_default.quadrantChart) == null
            ? void 0
            : _e.quadrantPadding) || 5,
        xAxisLabelPadding:
          ((_f = defaultConfig_default.quadrantChart) == null
            ? void 0
            : _f.xAxisLabelPadding) || 5,
        yAxisLabelPadding:
          ((_g = defaultConfig_default.quadrantChart) == null
            ? void 0
            : _g.yAxisLabelPadding) || 5,
        xAxisLabelFontSize:
          ((_h = defaultConfig_default.quadrantChart) == null
            ? void 0
            : _h.xAxisLabelFontSize) || 16,
        yAxisLabelFontSize:
          ((_i = defaultConfig_default.quadrantChart) == null
            ? void 0
            : _i.yAxisLabelFontSize) || 16,
        ...
        pointTextPadding:
          ((_l = defaultConfig_default.quadrantChart) == null
            ? void 0
            : _l.pointTextPadding) || 5,
        pointLabelFontSize:
          ((_m = defaultConfig_default.quadrantChart) == null
            ? void 0
            : _m.pointLabelFontSize) || 12,
        pointRadius:
          ((_n = defaultConfig_default.quadrantChart) == null
            ? void 0
            : _n.pointRadius) || 5,
        xAxisPosition:
          ((_o = defaultConfig_default.quadrantChart) == null
            ? void 0
            : _o.xAxisPosition) || 'top',
        yAxisPosition:
          ((_p = defaultConfig_default.quadrantChart) == null
            ? void 0
            : _p.yAxisPosition) || 'left',
    ...
    getDefaultThemeConfig() {
      return {
        ...
        quadrantInternalBorderStrokeFill:
          defaultThemeVariables.quadrantInternalBorderStrokeFill,
        quadrantExternalBorderStrokeFill:
          defaultThemeVariables.quadrantExternalBorderStrokeFill,
      };
    }
    clear() {
      this.config = this.getDefaultConfig();
    ...
    calculateSpace(xAxisPosition, showXAxis, showYAxis, showTitle) {
      ...
      const xAxisSpace = {
        ...
        bottom:
          xAxisPosition === 'bottom' && showXAxis ? xAxisSpaceCalculation : 0,
      };
      const yAxisSpaceCalculation =
        this.config.yAxisLabelPadding * 2 + this.config.yAxisLabelFontSize;
      const yAxisSpace = {
        left:
          this.config.yAxisPosition === 'left' && showYAxis
            ? yAxisSpaceCalculation
            : 0,
        right:
          this.config.yAxisPosition === 'right' && showYAxis
            ? yAxisSpaceCalculation
            : 0,
      };
      const titleSpaceCalculation =
      ...
      const quadrantTop =
        this.config.quadrantPadding + xAxisSpace.top + titleSpace.top;
      const quadrantWidth =
    ...
    getQuadrantPoints(spaceData) {
      const { quadrantSpace } = spaceData;
      const { quadrantHeight, quadrantLeft, quadrantTop, quadrantWidth } =
        quadrantSpace;
      const xAxis = linear()
        .domain([0, 1])
    ...
    build() {
      ...
      const calculatedSpace = this.calculateSpace(
        xAxisPosition,
        showXAxis,
        showYAxis,
        showTitle,
...
var InvalidStyleError =
  ((_a2 = class extends Error {
    constructor(style, value, type) {
      super(
        `value for ${style} ${value} is invalid, please use a valid ${type}`,
      );
...
var draw = __name((txt, id, _version, diagObj) => {
  ...
  const width =
    ((_a3 = conf.quadrantChart) == null ? void 0 : _a3.chartWidth) ?? 500;
  const height =
    ((_b = conf.quadrantChart) == null ? void 0 : _b.chartHeight) ?? 500;
  configureSvgSize(
    svg,
    height,
    width,
  ...
  if (quadrantData.title) {
    titleGroup
      ...
      .attr(
        'dominant-baseline',
        getDominantBaseLine(quadrantData.title.horizontalPos),
      )
  ...
  labels
    ...
    .attr('dominant-baseline', (data) =>
      getDominantBaseLine(data.horizontalPos),
    )
...
export { diagram };
//# sourceMappingURL=quadrantDiagram-337W2JSQ-JSR6ILKS.js.map
