import { require_react } from './chunk-LNK32FLG.js';
  ...
  'node_modules/react-telegram-login/build/index.js'(exports, module) {
    module.exports = (function (e) {
      ...
      function (e, t, r) {
            ...
            function e2(e3, t2) {
              for (var r2 = 0; r2 < t2.length; r2++) {
                ...
                (n2.enumerable = n2.enumerable || false),
                  ...
                  Object.defineProperty(e3, n2.key, n2);
              }
            }
          ...
          function t2(e3) {
            return (
              ...
              (function (e4, t3) {
                ...
                return !t3 || ('object' != typeof t3 && 'function' != typeof t3)
                  ? e4
                  : t3;
              })(
                this,
                (t2.__proto__ || Object.getPrototypeOf(t2)).call(this, e3),
              )
            );
          }
          return (
            ...
            n(t2, [
              {
                ...
                value: function () {
                  ...
                  window.TelegramLoginWidget = {
                    dataOnauth: function (e4) {
                      return u2(e4);
                    },
                  };
                  var c = document.createElement('script');
                  (c.src = 'https://telegram.org/js/telegram-widget.js?9'),
                    c.setAttribute('data-telegram-login', t3),
                    c.setAttribute('data-size', r2),
                    void 0 !== n2 && c.setAttribute('data-radius', n2),
                    c.setAttribute('data-request-access', o2),
                    c.setAttribute('data-userpic', a2),
                    c.setAttribute('data-lang', s),
                    void 0 !== i2
                      ? c.setAttribute('data-auth-url', i2)
                      : c.setAttribute(
                          'data-onauth',
                          'TelegramLoginWidget.dataOnauth(user)',
                        ),
                    (c.async = true),
                    this.instance.appendChild(c);
                },
              },
              {
                key: 'render',
        ...
        (i.propTypes = {
          botName: a.default.string.isRequired,
          dataOnauth: a.default.func,
          buttonSize: a.default.oneOf(['large', 'medium', 'small']),
          cornerRadius: a.default.number,
          requestAccess: a.default.string,
          usePic: a.default.bool,
