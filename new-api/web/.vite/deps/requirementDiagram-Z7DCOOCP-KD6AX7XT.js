...
import { __export, __name, log } from './chunk-OQUVF2X3.js';
      ...
      for (const id of ids) {
        ...
        if (node) {
          for (const _class of classNames) {
            ...
            const styles =
              (_a2 = this.classes.get(_class)) == null ? void 0 : _a2.styles;
            if (styles) {
    ...
    getData() {
      ...
      for (const relation of this.relations) {
        ...
        const edge = {
          ...
          start:
            ((_a2 = this.requirements.get(relation.src)) == null
              ? void 0
              : _a2.name) ??
            ((_b = this.elements.get(relation.src)) == null ? void 0 : _b.name),
          end:
            ((_c = this.requirements.get(relation.dst)) == null
              ? void 0
              : _c.name) ??
...
export { diagram };
//# sourceMappingURL=requirementDiagram-Z7DCOOCP-KD6AX7XT.js.map
