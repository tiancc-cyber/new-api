import {
  ...
  styles_default,
} from './chunk-E5MH7ENU.js';
import './chunk-R3RKKDF4.js';
import './chunk-CTM4C2AQ.js';
import { layout } from './chunk-5APHY2Y4.js';
import { Graph } from './chunk-ZWCNTER3.js';
import './chunk-NBEFCHMA.js';
...
var drawDescrState = __name((g, stateDef) => {
  ...
  const descrLine = g
    ...
    .attr(
      ...
      getConfig2().state.padding +
        titleHeight +
        getConfig2().state.dividerMargin / 2,
    )
    .attr(
      'y2',
      getConfig2().state.padding +
  ...
  g.insert('rect', ':first-child')
    ...
    .attr(
      'height',
      descrBox.height + titleHeight + 2 * getConfig2().state.padding,
    )
    .attr('rx', getConfig2().state.radius);
  return g;
}, 'drawDescrState');
...
var drawEndState = __name((g) => {
  g.append('circle')
    ...
    .attr(
      'cx',
      getConfig2().state.padding +
        getConfig2().state.sizeUnit +
        getConfig2().state.miniPadding,
    )
    .attr(
      'cy',
      getConfig2().state.padding +
...
var drawEdge = __name(function (elem, path, relation) {
  ...
  svgPath.attr(
    ...
    'url(' +
      url +
      '#' +
      getRelationType(StateDB.relationType.DEPENDENCY) +
      'End)',
  );
  if (relation.title !== void 0) {
    ...
    if (rows.length > 1) {
      ...
      titleRows.forEach((title, i) =>
        title.attr('y', y + i * titleHeight - heightAdj),
      );
...
var draw = __name(function (text, id, _version, diagObj) {
  ...
  diagram2.attr(
    'viewBox',
    `${bounds.x - conf.padding}  ${bounds.y - conf.padding} ` +
      width +
      ' ' +
      height,
  );
...
var renderDoc = __name(
  (doc, diagram2, parentId, altBkg, root, domDocument, diagObj) => {
    ...
    relations.forEach(function (relation) {
      ...
      graph.setEdge(
        ...
        relation.id2,
        {
          ...
          height:
            conf.labelHeight * common_default.getRows(relation.title).length,
          labelpos: 'c',
        },
        'id' + cnt,
      );
    ...
    graph.nodes().forEach(function (v) {
      if (v !== void 0 && graph.node(v) !== void 0) {
        ...
        const dividers = domDocument.querySelectorAll(
...
export { diagram };
//# sourceMappingURL=stateDiagram-RAJIS63D-ITI3BU2F.js.map
